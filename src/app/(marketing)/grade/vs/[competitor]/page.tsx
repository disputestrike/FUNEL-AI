...
import { competitorLabel, competitorMetadata, isKnownCompetitor } from "@/lib/grader/seo";
        ...
        <div className="mt-8 overflow-hidden rounded-2xl border border-ink-100 bg-white">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-ink-100">
              {[
                ["Hook strength", "Headline + value prop above the fold", "5-second test -> cold traffic conversion"],
          ...
          {[
            ...
            <details key={q} className="group py-4">
              <summary className="cursor-pointer list-none text-base font-semibold text-ink-900">
                {q}
                <span className="float-right text-ink-900/40 group-open:rotate-180 transition">v</span>
              </summary>

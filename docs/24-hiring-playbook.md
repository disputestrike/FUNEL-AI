# 24 â€” FunelAI Hiring Playbook

**Version:** 1.0
**Owner:** Founder / CEO (will transition to COO + VP Eng by month 13)
**Scope:** First 25 hires, months 1â€“18 post-launch.
...
- **PART A** is the ordered hire list with full role packets. Roles are numbered 1â€“25 in the sequence the founder should run them.
- **PART B** is the rubric library â€” each role family has its own rubric and loop structure.
...
# PART A â€” The 25 Roles

> Conventions: "IC" = individual contributor, levels 1â€“6. "M" = manager, levels 1â€“3. Comp bands are USD, SF/NY Ã— 1.0 baseline. Equity ranges are % of fully diluted post-Series A cap. Sign-on bonuses are post-tax retention tools; only listed where used.

---

## Months 1â€“3 â€” Founding team (roles 1â€“4)

### Role 1 â€” AI Engineer / Founding Engineer #1

- **Level:** IC5 (Founding)
- **Reports to:** Founder
- **Mandate:** Owns the orchestration engine â€” agent prompts, tool routing, eval harness, the planner/generator/critic loop, and the cost governor's runtime hooks (see 07c-cost-governor.md).
- **Primary responsibilities:**
  ...
  - Build the eval harness â€” golden sets per vertical, regression bench, A/B prompt routing.
...
- **Must-have qualifications:**
  ...
  - Has shipped an agentic system that calls tools â€” not just chat wrappers.
...
- **Interview rubric (engineering family â€” see PART B for full scale):**
  1. Technical depth â€” must be 5
  2. AI/LLM understanding â€” must be 5
  3. System thinking â€” must be 4+
  4. Ownership â€” must be 5
  5. Communication â€” must be 4+
...
- **Comp band:**
  - Base: $185kâ€“$215k (below market for level, deliberate)
  - Equity: 1.5%â€“3.0% (4yr vest, 1yr cliff, double-trigger accel)
  - Sign-on: $25k retention bonus, 12-month clawback
- **Location:** Remote. Must overlap 4 hours/day with US Pacific.

---

### Role 2 â€” Full-Stack Founding Engineer #2

- **Level:** IC5 (Founding)
- **Reports to:** Founder
- **Mandate:** Owns the customer-visible product surface â€” Next.js app, the funnel editor, the dashboard, the auth + billing stack, the Postgres schema, and the Cloudflare edge deployment.
- **Primary responsibilities:**
...
- **Must-have qualifications:**
  ...
  - Strong Postgres â€” schema design, query tuning, has lived through a real migration incident.
...
- **Interview rubric (engineering):**
  1. Technical depth â€” 5
  2. System thinking â€” 5
  3. AI/LLM understanding â€” 3+ (does not need to be deep here)
  4. Ownership â€” 5
  5. Communication â€” 4+
...
- **Primary responsibilities:**
  ...
  - Funnel component library â€” the actual blocks the AI assembles into pages, per vertical. 80 components by day 90.
...
- **Must-have qualifications:**
  ...
  - Strong brand range â€” has done both startup-cute and enterprise-trustworthy.
...
- **Interview rubric (design):**
  1. Visual craft â€” 5
  2. Product thinking â€” 4+
  3. Brand range â€” 4+
  4. Technical implementation knowledge â€” 4+
  5. Taste â€” 5
...
- **Comp band:**
  ...
  - Equity: 1.5%â€“2.5%
  - Sign-on: $20k
- **Location:** Remote. 4h overlap with US Pacific or CET (designer's choice â€” async-friendly role).

---

### Role 4 â€” Founding Engineer #3 (Platform / Integrations)

- **Level:** IC5 (Founding)
- **Reports to:** Founder
- **Mandate:** Owns the integration matrix and adapter SDK â€” every place a FunelAI-generated artifact has to land (CRMs, ad platforms, hosting targets, webhooks). See 04-integration-matrix-and-pal.md.
- **Primary responsibilities:**
  ...
  - Own webhook reliability â€” idempotency, replay, DLQ, observability.
  - Build the Publish-Acknowledgment flow (see 05e) â€” the technical layer behind the legal one.
...
## Months 4â€“6 â€” Expansion (roles 5â€“9)

### Role 5 â€” Head of Growth
...
- **Primary responsibilities:**
  - Own the K-factor: invite mechanics, "Powered by FunelAI" loop, affiliate program (initially solo; hires a growth marketer by month 9).
...
- **Must-have qualifications:**
  ...
  - Has shipped copy that converted â€” not just briefed it.
...
- **Interview rubric (growth):**
  1. Experimentation mindset â€” 5
  2. Channel literacy â€” 4+
  3. Math fluency â€” 4+
  4. Copywriting â€” 4+
  5. Founder-mentality â€” 5
  - **Hire threshold:** â‰¥4 on all five.
- **Loop:** Founder screen â†’ portfolio + numbers walk-through (show me your experiment log) â†’ growth exercise (audit FunelAI funnel, propose 5 experiments with sized impact) â†’ pair-think session with founder â†’ references. Decision: founder lead.
- **Comp band:**
  - Base: $190kâ€“$220k
  - Equity: 0.5%â€“0.8%
  - Sign-on: $20k
...
### Role 6 â€” Head of Content

- **Level:** IC6 (player-coach)
- **Reports to:** Founder
- **Mandate:** Runs the founder content engine â€” YouTube long-form, shorts, podcast, X/LinkedIn, the book, the newsletter. Treats the founder's calendar as the production constraint. See 09-founder-content-pack.md.
- **Primary responsibilities:**
  ...
  - Build the recruiting-via-content loop â€” every video has a "we're hiring" CTA.
...
- **Must-have qualifications:**
  ...
  - Has published their own thing â€” newsletter, podcast, channel â€” and can show the numbers.
...
- **Interview rubric (content):**
  1. Voice match â€” 5
  2. Distribution understanding â€” 4+
  3. Production speed â€” 4+
  4. Founder-ghostwriting ability â€” 5
  5. Range â€” 4+
...
- **Interview rubric (ops, modified):**
  1. Scaling experience â€” 4+
  2. Systems thinking â€” 4+
  3. Conflict resolution â€” 5 (this role lives in conflict)
  4. Talent magnetism (recruiting hub leaders) â€” 4+
  5. Calm-under-fire â€” 5
  - **Hire threshold:** â‰¥4 on all; 5 on conflict resolution and calm.
- **Loop:** Founder screen â†’ community audit exercise (audit FunelAI's existing audience + propose 90-day plan) â†’ role-play (handle a difficult member, handle a hub leader who's gone off-message) â†’ references (must include 2 community members from prior role, not just managers). Decision: Head of Growth lead, founder confirm.
- **Comp band:**
  - Base: $110kâ€“$135k
  - Equity: 0.15%â€“0.3%
- **Location:** Remote. Any timezone â€” community runs 24/7.

---

### Role 8 â€” Compliance / Legal Counsel (FTE)
...
- **Interview rubric (legal):**
  1. AI regulation depth â€” 5
  2. FTC familiarity â€” 5
  3. International privacy â€” 4+
  4. Business-friendly judgment â€” 5 (we need a "how do we ship this safely" lawyer, not a "no" lawyer)
  5. Communication â€” 4+
...
### Role 9 â€” Customer Success Lead
...
- **Primary responsibilities:**
  - Own the activation funnel â€” time-to-first-funnel, time-to-first-published, time-to-first-conversion.
...
- **Must-have qualifications:**
  - 5+ years CS, with 2+ years at a PLG SaaS company at $1Mâ€“$50M ARR stage.
...
- **Interview rubric (ops, modified for CS):**
  1. Scaling experience â€” 4+
  2. Systems thinking â€” 4+
  3. Conflict resolution â€” 5
  4. Talent magnetism â€” 4+
  5. Calm-under-fire â€” 5
...
## Months 7â€“9 â€” Mobile + scale (roles 10â€“15)

### Role 10 â€” Mobile Engineer (iOS)

- **Level:** IC4
- **Reports to:** Founder (will report to VP Eng)
- **Mandate:** Owns iOS app â€” React Native shell with native modules where performance demands it. Pairs with role 11 (Android) on shared RN codebase.
- **Primary responsibilities:**
...
- **Comp band:** Base $170kâ€“$195k, equity 0.15%â€“0.30%.
- **Location:** Remote. 4h overlap US Pacific.

---

### Role 11 â€” Mobile Engineer (Android)
...
### Role 12 â€” DevOps / SRE Engineer

- **Level:** IC5
- **Reports to:** Founder (will report to VP Eng)
- **Mandate:** Owns infrastructure operations â€” Cloudflare topology, Postgres operations, Redis, observability, on-call rotation, cost monitoring.
- **Primary responsibilities:**
...
- **Comp band:** Base $190kâ€“$220k, equity 0.25%â€“0.45%, sign-on $15k.
- **Location:** Remote. Must overlap 4h US Pacific. Carries on-call.

---

### Role 13 â€” Head of Education / Academy
...
- **Primary responsibilities:**
  - Build FunelAI Academy: video course (3 tracks â€” solo founder, agency, in-house marketer).
  - Run the college pilot â€” 10 universities by month 12, including HBCU partnerships (D&I + commercial overlap; see PART H).
  - Certification program (FunelAI Certified Builder, Certified Agency Partner).
...
- **First-90-days impact:** Curriculum framework + first track scripted by day 30; first 2 courses shipped by day 60; college pilot â€” 3 pilot universities signed by day 90.
...
- **Loop:** Founder screen â†’ portfolio (show me a course you built + the numbers) â†’ curriculum exercise (design a 3-track curriculum for FunelAI, 1 week) â†’ working session â†’ references.
- **Comp band:** Base $160kâ€“$185k, equity 0.3%â€“0.5%.
- **Location:** Remote.

---

### Role 14 â€” Trust & Safety Lead
...
- **Primary responsibilities:**
  - Own the human review queue â€” SLAs, reviewer training, quality calibration.
...
- **Comp band:** Base $140kâ€“$165k, equity 0.2%â€“0.4%.
- **Location:** Remote.

---

### Role 15 â€” Senior Frontend Engineer

- **Level:** IC5
- **Reports to:** Founder (will report to VP Eng)
- **Mandate:** Owns design system polish, accessibility, component library at production-quality. Lifts the bar above what the founding engineers + designer set in months 1â€“6.
- **Primary responsibilities:**
  ...
  - Performance â€” Lighthouse / Core Web Vitals discipline.
...
- **Comp band:** Base $175kâ€“$200k, equity 0.20%â€“0.35%.
- **Location:** Remote.

---

## Months 9â€“12 â€” Agency + sales (roles 16â€“20)

### Role 16 â€” VP Engineering

- **Level:** M3
- **Reports to:** Founder
- **Mandate:** Engineering management â€” hiring rubric ownership, on-call structure, performance management, eng ops, technical bar protection. Founder gradually hands off all engineering management to this role.
- **Primary responsibilities:**
...
- **Interview rubric (engineering + ops blend):** Tech depth 4+, System thinking 5, AI/LLM 3+, Ownership 5, Comms 5; ALSO from ops rubric â€” Scaling 5, Talent magnetism 5, Calm 5.
...
- **Comp band:** Base $260kâ€“$300k, equity 0.8%â€“1.5%, sign-on $50k.
- **Location:** Remote. 4h overlap US Pacific.

---

### Role 17 â€” Head of Sales (Agency channel)
...
- **Primary responsibilities:**
  ...
  - Quota carry â€” first year carrying personal quota.
- **Must-have:** 8+ years sales, with 3+ years closing $50kâ€“$500k ARR deals; has sold to agencies before; has built a partner channel from zero.
...
- **Loop:** Founder screen â†’ discovery role-play (with a senior agency owner from founder's network) â†’ demo role-play (sell FunelAI to a 20-person agency) â†’ strategy plan (build the agency partner program, 1 week) â†’ references (must include 2 channel-partner contacts who'll vouch for them). Decision: founder lead.
- **Comp band:** Base $180kâ€“$210k + OTE $360kâ€“$420k at 100% quota, equity 0.4%â€“0.7%.
...
- **Loop:** Founder screen â†’ press strategy exercise (build a 90-day press plan for FunelAI's solar vertical launch) â†’ crisis sim (we throw a fake media inquiry, watch them work) â†’ references (2 reporters who've worked with them).
- **Comp band:** Base $170kâ€“$200k, equity 0.2%â€“0.4%.
- **Location:** Remote, US.

---

### Role 19 â€” Data Engineer
...
- **Comp band:** Base $200kâ€“$230k, equity 0.3%â€“0.5%, sign-on $20k.
- **Location:** Remote.

---

### Role 20 â€” Designer #2 (Marketing + content design)
...
- **Loop:** Founding Designer screen â†’ portfolio â†’ design exercise (redesign the FunelAI marketing homepage hero in 3 directions) â†’ working session â†’ references.
- **Comp band:** Base $140kâ€“$165k, equity 0.10%â€“0.20%.
- **Location:** Remote.

---

## Months 12â€“18 â€” COO + international (roles 21â€“25)
...
- **Primary responsibilities:**
  ...
  - Own the hiring engine â€” recruiters, sourcers, hiring rubrics, comp committee.
...
- **Comp band:** Base $300kâ€“$350k, equity 1.0%â€“2.0%, sign-on $100k.
- **Location:** Remote, with travel. Must be willing to travel to founder's location 1 week/month.

---

### Role 22 â€” Head of International

- **Level:** IC6 / M1
- **Reports to:** COO (or founder if COO not yet hired)
- **Mandate:** Expansion ops â€” localization, partner relationships, country-launch execution (see 15-country-launch-checklists.md).
- **Primary responsibilities:**
  - Own country-launch sequencing â€” UK, Canada, Australia, then EU big-5, then LATAM.
...
- **Comp band:** Base $200kâ€“$235k, equity 0.4%â€“0.7%.
- **Location:** Remote, EU or UK preferred for timezone coverage.

---

### Role 23 â€” Senior Customer Success Manager (Agency tier)
...
- **Primary responsibilities:**
  - Portfolio of 30â€“50 agency accounts.
...
- **Comp band:** Base $130kâ€“$155k + variable $30kâ€“$50k on retention/expansion, equity 0.10%â€“0.20%.
- **Location:** Remote.

---

### Role 24 â€” Senior Engineer (Generation Engine focus)
...
- **Primary responsibilities:**
  - Owns the eval system at maturity â€” golden sets per vertical, automated grading, regression dashboards.
  - Owns the fine-tuning pipeline (open-weight models for cost-sensitive paths).
  - Prompt engineering depth â€” RAG quality, retrieval tuning, chain-of-thought design, structured output reliability.
...
- **Comp band:** Base $240kâ€“$280k, equity 0.4%â€“0.7%, sign-on $30k.
- **Location:** Remote.

---

### Role 25 â€” Operations / Finance Lead
...
- **Comp band:** Base $160kâ€“$185k, equity 0.15%â€“0.30%.
- **Location:** Remote, US preferred.

---

# PART B â€” Interview Rubrics

The rubric library is shared across roles in a family. For each rubric: dimensions, the 1â€“5 anchor descriptions, hire threshold, and the interview loop structure.

**Scoring conventions:** Each interviewer scores 1â€“5 on each dimension, with a written 2â€“4 sentence justification. Scorecards are submitted before debrief â€” no "anchoring" by reading others' first. Debrief is conducted by the hiring manager.

---

## B.1 â€” Engineering rubric

**Dimensions:** Technical depth, System thinking, AI/LLM understanding, Ownership, Communication.

**Technical depth:**
- 1 â€” Cannot complete the take-home or produces non-functional code.
- 2 â€” Code works but is fragile, naive, or shows weak fundamentals (sync issues, no error handling, no tests).
- 3 â€” Solid working code. Reasonable patterns. Would ship after review.
- 4 â€” Strong. Idiomatic, defensive, tested. Spots and resolves edge cases unprompted.
- 5 â€” Elite. Anticipates failure modes we hadn't considered. Code is the kind we'd reference in onboarding.

**System thinking:**
- 1 â€” Cannot reason about systems beyond a single service.
- 2 â€” Can describe components but misses interactions, failure modes, or data flow.
- 3 â€” Reasonable system design. Explains tradeoffs. Misses some non-obvious failure modes.
- 4 â€” Strong system reasoning. Spots non-obvious failure modes, capacity issues, and operational concerns.
- 5 â€” Designs systems we want to copy. Reasons about cost, capacity, observability, security, and migration concurrently.

**AI/LLM understanding:**
- 1 â€” Has never shipped an LLM-backed feature.
- 2 â€” Has used the OpenAI/Anthropic SDK in a side project; surface-level prompt knowledge.
- 3 â€” Has shipped one LLM feature in production. Understands tokens, temperature, costs.
- 4 â€” Has shipped multiple LLM features. Knows when to use RAG vs fine-tune vs prompt. Has written an eval.
- 5 â€” Lives inside the space. Has built eval harnesses, agentic systems, fine-tuning pipelines. Reads papers.

**Ownership:**
- 1 â€” Looking for someone to assign tasks.
- 2 â€” Will complete assigned work but doesn't extend scope or surface issues proactively.
- 3 â€” Owns assigned work end-to-end. Surfaces issues. Asks for help when stuck.
- 4 â€” Owns problems, not tasks. Defines scope, escalates well, follows through to outcome.
- 5 â€” Owns outcomes. Will redirect the team if the plan is wrong. Reliable for "founder-pace" work.

**Communication:**
- 1 â€” Cannot explain decisions clearly. Defensive when challenged.
- 2 â€” Explains decisions but loses non-experts. Doesn't write things down.
- 3 â€” Communicates clearly in conversation. Documents acceptably.
- 4 â€” Strong written + verbal. Documents proactively. Disagrees well.
- 5 â€” Communication is a multiplier â€” they make their teammates better.
...
**Loop:**
1. Founder/VP-Eng screen â€” 30 min, fit + role calibration.
2. Take-home â€” bounded (4â€“8h), reviewed by the hiring manager + one peer.
3. Tech deep-dive â€” 90 min, walk through the take-home + extend it live.
4. System design â€” 60 min, with a senior engineer or external advisor.
5. (Optional) Pair-coding round â€” 60 min, real codebase issue or extension.
6. References â€” 3, on-list, conducted by hiring manager.
...
**Visual craft:**
- 1 â€” Inconsistent typography, spacing, alignment in portfolio.
- 2 â€” Acceptable craft but not memorable.
- 3 â€” Solid craft. Would ship without rework.
- 4 â€” Strong craft. Defaults are tasteful; details are considered.
- 5 â€” Reference-quality. The kind of craft that sets the company ceiling.

**Product thinking:**
- 1 â€” Designs without engaging with the problem.
- 2 â€” Considers UX but not business logic or technical constraints.
- 3 â€” Reasonable product instincts. Asks the right questions.
- 4 â€” Strong product thinking. Reframes problems. Pushes back on the brief well.
- 5 â€” Co-author of strategy, not just executor. Often spots the bigger opportunity.

**Brand range:**
- 1 â€” One look, applied everywhere.
- 2 â€” Limited range â€” can do startup-cute OR enterprise but not both.
- 3 â€” Comfortable range across 2â€“3 brand registers.
- 4 â€” Broad range. Has shipped both creator-friendly and enterprise-credible work.
- 5 â€” Could brand-direct multiple companies in different categories convincingly.

**Technical implementation knowledge:**
- 1 â€” Hands off Figma and disappears.
- 2 â€” Knows engineering will translate but not how.
- 3 â€” Designs with technical constraints in mind. Reads CSS.
- 4 â€” Strong technical fluency. Writes some HTML/CSS. Designs in a way engineers love.
- 5 â€” Could ship the design themselves if needed.

**Taste:**
- 1 â€” Defaults to trends without judgment.
- 2 â€” Taste is acceptable but not distinctive.
- 3 â€” Tasteful by industry standards.
- 4 â€” Distinctive taste. Choices feel intentional.
- 5 â€” World-class taste. The kind we'd want defining the company aesthetic.

**Hire threshold:** Founding Designer â€” 5 on craft AND taste, â‰¥4 on the other three. Designer #2 â€” â‰¥4 on craft, brand range, taste; â‰¥3 on the other two.

**Loop:**
1. Founder screen â€” 30 min.
2. Portfolio deep-dive â€” 90 min, live walk-through (not slides). Designer drives the conversation.
3. Design exercise â€” bounded (4h), reviewed live in a working session.
4. Working session with founder â€” 90 min, co-design something small.
5. References â€” 3, on-list.
...
- 1 â€” Pitches "best practices" without testing them.
- 2 â€” Runs experiments occasionally; cannot calculate significance.
- 3 â€” Runs experiments regularly. Logs results. Reasonable hypotheses.
- 4 â€” Lives in the experiment log. Sizes impact before running. Kills experiments fast when wrong.
- 5 â€” Built and runs an experimentation system that compounds team learning.

**Channel literacy:**
- 1 â€” Deep in one channel, blind to the rest.
- 2 â€” Comfortable in 2 channels. Can speak to others.
- 3 â€” Comfortable across paid, content, community, and viral loops.
- 4 â€” Strong across all channels with measurable wins in 3+.
- 5 â€” Channel-agnostic. Picks the right channel for the moment and shifts spend fluidly.

**Math fluency:**
- 1 â€” Cannot calculate CAC payback or LTV.
- 2 â€” Reasonable spreadsheet but no SQL.
- 3 â€” Solid spreadsheet + basic SQL. Reads a cohort chart.
- 4 â€” Strong analyst-grade math. SQL fluent. Builds models in Hex/Mode.
- 5 â€” Could be hired as the analyst. Builds the dashboards the team runs against.

**Copywriting:**
- 1 â€” Cannot write a converting headline.
- 2 â€” Writes acceptable copy with help.
- 3 â€” Writes solid copy. Shipped converting work.
- 4 â€” Writes copy that beats agencies. Multiple wins on file.
- 5 â€” Could be a copywriter-as-a-career. Headlines lift conversion measurably.

**Founder-mentality:**
- 1 â€” Wants a clear playbook handed to them.
- 2 â€” Can run a playbook but won't extend it.
- 3 â€” Owns their area. Builds playbook chunks.
- 4 â€” Acts like a founder. Builds systems. Owns outcomes.
- 5 â€” Will eventually start their own company. Will run hard for 3â€“5 years here in the meantime.

**Hire threshold:** Head of Growth â€” â‰¥4 on all five. Growth ICs (later hires) â€” â‰¥4 on three including experimentation and one of math/copy.

**Loop:**
1. Founder screen â€” 30 min.
2. Portfolio walk-through â€” 60 min. Show me the experiment log and the wins.
3. Growth exercise â€” bounded (1 week), audit FunelAI's funnel + propose 5 experiments with sized impact.
4. Working session â€” 90 min with founder, sharpen the exercise.
5. References â€” 3.
...
## B.4 â€” Content rubric

**Dimensions:** Voice match, Distribution understanding, Production speed, Founder-ghostwriting ability, Range.

**Voice match:**
- 1 â€” Cannot match a voice. Writing reads as generic.
- 2 â€” Some voice match with heavy editing.
- 3 â€” Reasonable voice match after a few rounds.
- 4 â€” Strong voice match on first or second draft.
- 5 â€” Indistinguishable from the founder's own writing.

**Distribution understanding:**
- 1 â€” Writes without thinking about distribution.
- 2 â€” Understands one channel.
- 3 â€” Designs content for the channel. Comfortable in 2â€“3 surfaces.
- 4 â€” Designs across the multi-channel surface (long â†’ short â†’ social â†’ newsletter).
- 5 â€” Distribution-native. Designs content so each surface feeds the next.

**Production speed:**
- 1 â€” Slow. Misses deadlines.
- 2 â€” On-time with reminders.
- 3 â€” Reliable cadence. Hits deadlines.
- 4 â€” Fast. Beats deadlines. Manages contractors well.
- 5 â€” Founder-pace. Could ship a campaign in 48h.

**Founder-ghostwriting ability:**
- 1 â€” Cannot ghostwrite â€” pulls toward their own voice.
- 2 â€” Ghostwrites with heavy editing.
- 3 â€” Reasonable ghostwriting after voice-onboarding.
- 4 â€” Strong ghostwriting. The founder shipped a piece they didn't write.
- 5 â€” The founder cannot tell which pieces they wrote.

**Range:**
- 1 â€” One format only.
- 2 â€” Two formats.
- 3 â€” Comfortable across 3 formats.
- 4 â€” Strong across long-form video script, podcast outline, threads, newsletter, ad copy.
- 5 â€” Could be hired as any of the above roles standalone.

**Hire threshold:** Head of Content â€” 5 on voice match + ghostwriting, â‰¥4 elsewhere. PR Lead uses content rubric with extra weight on Distribution + Calm-under-fire.

**Loop:**
1. Founder screen â€” 30 min.
2. Voice test â€” 24h turnaround, write a 600-word LinkedIn post in the founder's voice on a founder-picked topic.
3. Portfolio walk-through â€” 60 min.
4. Working session â€” 90 min, co-script a 12-min YouTube video.
5. References â€” 3.
...
**Prospecting:**
- 1 â€” Waits for inbound.
- 2 â€” Runs prospecting playbooks but doesn't customize.
- 3 â€” Customized outreach with reasonable response rates.
- 4 â€” Strong personalization. High response rates. Multi-thread accounts.
- 5 â€” Builds prospecting systems that compound.

**Discovery:**
- 1 â€” Pitches before discovering.
- 2 â€” Asks surface questions.
- 3 â€” Solid discovery with MEDDIC or similar framework.
- 4 â€” Deep discovery. Surfaces unspoken concerns. Maps the buying committee.
- 5 â€” Discovery is the sale. By the time they pitch, the buyer is already sold.

**Demo skill:**
- 1 â€” Walks through every feature.
- 2 â€” Demos to the discovery findings but uneven.
- 3 â€” Tight demos tied to the buyer's problem.
- 4 â€” Demo is a story. Buyer is leaning in.
- 5 â€” Demo is the highlight reel of why this customer needs us specifically.

**Objection handling:**
- 1 â€” Goes defensive on objections.
- 2 â€” Has scripted answers but no improvisation.
- 3 â€” Handles objections cleanly.
- 4 â€” Reframes objections into the close.
- 5 â€” Objections become commitment moments.

**Follow-through:**
- 1 â€” Loses deals in the gap between meetings.
- 2 â€” Reasonable follow-up cadence.
- 3 â€” Tight follow-up. CRM hygiene.
- 4 â€” Multi-thread, multi-touch, multi-channel follow-up. Deals don't go cold.
- 5 â€” Pipeline reliability is their reputation.

**Hire threshold:** Head of Sales â€” â‰¥4 on all five; 5 on discovery + demo. AEs (later) â€” â‰¥4 on three including prospecting + follow-through.

**Loop:**
1. Founder screen â€” 30 min.
2. Discovery role-play â€” 45 min with a senior agency owner from the founder's network as the "buyer."
3. Demo role-play â€” 45 min, sell FunelAI to a fictional 20-person agency.
4. Strategy plan â€” 1 week, build the agency partner program.
5. References â€” 3 (must include 1 customer and 1 channel partner).
...
**Scaling experience:**
- 1 â€” Has only operated at one stage.
- 2 â€” Has scaled a function at one company.
- 3 â€” Has scaled across two stages (e.g., 25 â†’ 75 people).
- 4 â€” Has scaled across multiple companies/stages.
- 5 â€” Scaled an org from <25 to 100+ as the operating leader.

**Systems thinking:**
- 1 â€” Tactical. Fixes the immediate fire.
- 2 â€” Builds local systems but doesn't connect them.
- 3 â€” Designs systems that interconnect. Documents.
- 4 â€” Strong systems thinker. Defaults to "what's the system" before "what's the fix."
- 5 â€” Designs the operating system of the company.

**Conflict resolution:**
- 1 â€” Avoids conflict.
- 2 â€” Mediates when forced.
- 3 â€” Engages conflict cleanly.
- 4 â€” Surfaces and resolves conflict proactively.
- 5 â€” Conflict is a tool. Uses it to align the team. People feel safer after, not worse.

**Talent magnetism:**
- 1 â€” Cannot attract talent.
- 2 â€” Refers occasional candidates.
- 3 â€” Has hired their team successfully.
- 4 â€” People follow them between companies.
- 5 â€” Famous-in-their-niche. Recruits we couldn't otherwise reach.

**Calm-under-fire:**
- 1 â€” Panics in crisis.
- 2 â€” Functional but tense.
- 3 â€” Calm during normal pressure.
- 4 â€” Calm during real crises. Others lean on them.
- 5 â€” Reference-quality crisis operator. Has run a crisis at $100M+ stakes.

**Hire threshold:** COO â€” â‰¥5 on scaling, systems, talent magnetism, AND calm. Head of International / CS Lead / T&S Lead / Ops & Finance Lead â€” â‰¥4 on at least 4 of 5.

**Loop:**
1. Founder/COO screen â€” 30 min.
2. Strategy session â€” 60 min, review one part of the company, propose changes.
3. Leadership panel â€” 60 min with existing heads.
4. Working session â€” 90 min, deep-dive on a real problem.
5. References â€” 5, must include 2 reports.
...
**AI regulation depth:**
- 1 â€” Hasn't tracked AI regulation.
- 2 â€” Reads headlines.
- 3 â€” Tracks the major frameworks (EU AI Act, US state laws, NIST AI RMF).
- 4 â€” Has shipped policy for a generative-AI product.
- 5 â€” Is a recognized voice in the space; has published.

**FTC familiarity:**
- 1 â€” Surface knowledge.
- 2 â€” Knows Â§5 unfairness/deception.
- 3 â€” Has handled FTC-adjacent matters.
- 4 â€” Has lived through an FTC inquiry.
- 5 â€” FTC alumna or has handled multiple inquiries to resolution.

**International privacy:**
- 1 â€” US only.
- 2 â€” GDPR awareness.
- 3 â€” Comfortable with GDPR + CCPA + LGPD.
- 4 â€” Has shipped multi-jurisdictional privacy programs.
- 5 â€” DPO-grade. Has run cross-border data transfer disputes.

**Business-friendly judgment:**
- 1 â€” "No" lawyer.
- 2 â€” Slow but eventually yes.
- 3 â€” Reasonable risk balancing.
- 4 â€” Finds the way to yes. Articulates risk in business terms.
- 5 â€” Operating partner. The team treats them as a strategist.

**Communication:**
- 1 â€” Writes only in legalese.
- 2 â€” Translates with effort.
- 3 â€” Communicates clearly to non-lawyers.
- 4 â€” Strong writer. Memos are usable directly.
- 5 â€” Could write the company blog post on a regulatory matter directly.

**Hire threshold:** â‰¥4 on all five; 5 on AI regulation + business-friendly judgment.

**Loop:**
1. Founder screen.
2. Written memo exercise â€” 1 week. Draft a memo on the publish-ack legal risk.
3. Deep-dive on memo + 3 scenario role-plays.
4. Meeting with outside counsel as a fit check.
5. References â€” 3, including 1 former in-house client.

**Decision rule:** Founder leads.

---

# PART C â€” Sourcing Strategy

**Order of operations for every role:**
1. Warm intro from founder network â€” always start here. 60% of first 25 hires should come from here.
2. Reverse-recruit from named companies (see below).
3. Founder content recruiting â€” every YouTube video, every long thread ends with "we're hiring, here's the role."
4. Public engineering / design / growth communities.
5. Specialty Slack/Discord communities.
6. Recruiters â€” only for specialist roles (Compliance Counsel, COO, VP Eng). Use Daversa, True, or an AI-native boutique for executive search.

---

## C.1 â€” Engineering sourcing

**Companies to reverse-recruit from:**
- Vercel â€” DX-focused engineers, Next.js depth.
- Linear â€” quality bar reference, design-aware engineers.
- Notion â€” multi-tenant SaaS experience, scale.
- Anthropic / OpenAI â€” applied research engineers (target the applied team, not research).
- Cloudflare â€” edge runtime depth.
- Stripe â€” platform engineers, billing depth.
- Cal.com, Resend, Liveblocks, Supabase, PlanetScale, Render â€” younger-cohort engineers.
...
- Founding/early engineer at a YC W23â€“W25 cohort company that's stalled.
...
## C.7 â€” Legal sourcing

**Companies / firms:**
- Anthropic, OpenAI, Stripe, Notion, Figma legal departments.
- Stability / Runway / Midjourney legal.
- Fenwick, Cooley, Wilson Sonsini, Goodwin AI practice associates 5â€“8 years in.
...
# PART D â€” Compensation Philosophy

## D.1 â€” Bands

**Founding team (roles 1â€“4):** Below-market base (15â€“25% below SF-market for the level), above-market equity (1.25%â€“3.0% each). Rationale: maximum equity capture, deep alignment.

**Senior team (roles 5â€“15):** Market base, above-market equity (0.20%â€“0.80%). Rationale: still building the company; equity should compensate for risk.

**Specialists (roles 16â€“25, non-executive):** Market base, market equity (0.05%â€“0.30%). Rationale: the company has more proof-points by this stage; cash compensation can be more competitive.

**Executives (VP Eng, Head of Sales, COO):** Market base, above-market equity (0.5%â€“2.0%). Rationale: these hires shape the second-act company.
...
- Single-trigger 25% acceleration for founding team (roles 1â€“4) on acquisition â€” they took the highest risk.

## D.3 â€” Cash conservation tactics

**Months 1â€“12 â€” bootstrap mindset:**
- Below-market cash for the first 4 hires.
- Equity-heavy offers across the board.
- Sign-on bonuses small ($15kâ€“$30k) and back-loaded with 12-month clawback.
- Hire in lower-cost geographies where role allows (see geographic adjustment).

**Months 12+ â€” post-raise (or post-revenue traction):**
...
| UK (London) | 0.80 | |
| EU (Western â€” Berlin, Amsterdam, Paris) | 0.75 | |
| EU (Eastern â€” Warsaw, Prague, Lisbon) | 0.65 | |
...
## D.5 â€” Equity refresh

- Year 4: top-performers (top-quartile by perf review) get a refresh grant equal to 25â€“50% of their original grant, vesting over 4 years from refresh date.
...
# PART E â€” Onboarding Per Role (30/60/90)
...
## E.2 â€” Days 31â€“60: Contributing
...
- New hire writes a "30-day reflection" â€” what's working, what isn't, what they'd change.
...
- Is a culture-add â€” others want to work with them.
- Has surfaced at least one improvement to how we work.

## E.4 â€” Reading list (every role, in order)
...
# PART F â€” Founder Time Allocation
...
## F.1 â€” Time allocation by month

| Month | Product | Hiring | Sales | Legal | Content | Press / Community | Strategy | Fundraising | Team |
|---|---|---|---|---|---|---|---|---|---|
| 1â€“3 | 60% | 20% | â€” | 10% | 10% | â€” | â€” | â€” | â€” |
| 4â€“6 | 40% | 25% | 15% | 10% | 10% | â€” | â€” | â€” | â€” |
| 7â€“12 | 25% | 25% | 20% | â€” | â€” | 15% | 15% | â€” | â€” |
| 12+ | 15% | 20% | â€” | â€” | â€” | 25% | 20% | 20% | 20% |
...
## F.3 â€” Founder discipline

- Block 4 hours/day on product, calendar-protected, no meetings.
- One "hiring day" per week â€” back-to-back interviews, debriefs, and reference calls. No engineering on hiring days.
...
# PART G â€” Founders + First-25 Equity Allocation

## G.1 â€” Capitalization model (post-Series A, fully diluted)

| Bucket | Range | Notes |
|---|---|---|
| Founder(s) | 60%â€“70% | Single founder model. If co-founder added later, split per agreement. |
| Founding team (roles 1â€“4) | 5%â€“12% total | 1.25%â€“3.0% each. |
| Senior team (roles 5â€“15) | 4%â€“7% total | 0.20%â€“0.80% each. |
| Specialists (roles 16â€“25, non-exec) | 1.5%â€“3% total | 0.05%â€“0.30% each. |
| Executive (VP Eng, Head Sales, COO) | 2%â€“4% total | 0.5%â€“2.0% each. |
| Advisors | 0.5%â€“2% total | Across 3â€“5 advisors. |
| Option pool (for hires 26+) | 5%â€“8% post-Series-A refresh | Topped up at each financing. |

Total checks: founder + team + advisors â‰ˆ 80%â€“90%; investor stakes (Series A + any pre-A SAFEs) fill the remainder.

## G.2 â€” Advisor program

- 3â€“5 advisors total.
- Each: 0.1%â€“0.5%, 2-year vest, no cliff, monthly vest.
- Categories: AI/research, growth, creator/content, sales/enterprise, legal/regulatory.
- Reviewed at year 2 â€” non-active advisors stop vesting (defined activity threshold: 1 meeting/quarter + 2 intros/year).

## G.3 â€” Founder's offer-letter terms (template)

Every offer letter for a founding-team hire (roles 1â€“4) includes:
- Title, level, reports-to, start date.
- Base salary, equity grant (in shares + % of fully diluted at the time of grant).
- Vesting schedule (4yr, 1yr cliff, monthly thereafter, double-trigger accel on acquisition, 25% single-trigger accel for roles 1â€“4).
- IP Assignment Agreement (signed at start; assigns all work-product IP).
- Confidentiality / NDA.
- Non-compete: where enforceable (and tailored â€” not US-blanket, given enforceability variance). Default to non-solicit of customers + employees for 12 months.
...
Roles 5â€“25 use a similar template, scaled down for the equity range and without single-trigger acceleration.
...
These are aggregate targets, tracked monthly. They are commitments, not quotas â€” we will not lower the bar to hit them, but we will widen the pipeline aggressively to surface candidates we'd otherwise miss.

## H.2 â€” Pipeline tracking
...
## H.3 â€” Sourcing channels for diverse pipeline

- **HBCU career centers** â€” same network as the college pilot (see role 13). Specifically: Howard, Spelman, Morehouse, FAMU, North Carolina A&T, Hampton. Target schools annually for both academy partnerships and engineering pipeline.
...
## Appendix A â€” Quick-reference: who is the founder interviewing this week?

Use this as the founder's weekly hiring sprint planner. The cell answers "what is the next active loop?"

| Month | Active loops |
|---|---|
| 1 | Role 1 (AI Eng), Role 2 (Full-Stack) â€” both in active loop |
...
| 9 | Role 16 (VP Eng) â€” highest-priority loop |
| 10 | Roles 16, 17 (Head of Sales) |
| 11 | Roles 18 (PR), 19 (Data Eng), 20 (Designer #2) |
| 12 | Role 21 (COO) loop opens â€” only when trigger conditions met (PART F.2) |
| 13â€“15 | Roles 21, 22 (Intl), 23 (Sr CSM) |
| 16â€“18 | Roles 24 (Sr Eng), 25 (Ops/Finance Lead) |

## Appendix B â€” One-page founder cheat sheet
...
â€” End of 24-hiring-playbook.md â€”

# GoFunnelAI — Country-by-Country Launch Checklists

**Document:** 15-country-launch-checklists.md
**Owner:** VP International (hire by Month 2) — interim owner: COO
...
Each country has 10 sections (A–J). The country owner runs every box in J first, then walks down Aâ†’I. Sections A (Legal) and C (Compliance) must be cleared by counsel before public launch in that country. Sections B, F, and H are engineering dependencies — schedule a 30-day lead with the platform team.

The "Pre-launch / Launch / 30-day / 90-day" phasing in section I is the canonical timeline. If a country slips on legal review, slip the whole country — do not soft-launch without local counsel sign-off.
...
- **Local counsel:** Cooley LLP or Wilson Sonsini (SaaS/AI specialist); secondary for TCPA defense — Klein Moynihan Turco LLP or Mac Murray Petersen Shuster LLP.
...
- **AI disclosure:** Federal — no comprehensive AI law yet, but FTC Section 5 on deceptive AI claims applies. State-level: CA AB 2013 (training data transparency), CA SB 942 (AI Transparency Act — provenance for generative output), Colorado AI Act (effective Feb 2026 — high-risk AI systems consequential decisions), Utah AI Policy Act (disclosure when consumer interacts with generative AI in regulated occupations), Texas TRAIGA. Disclose: "You are interacting with an AI" before any AI-generated voice/chat conversation initiates.
- **Telemarketing (TCPA-equivalent):** TCPA itself. Prior Express Written Consent (PEWC) required for any AI-generated or pre-recorded voice call AND for autodialed calls to wireless numbers. FCC 2024 ruling: AI-generated voice = "artificial voice" under TCPA — requires PEWC regardless of B2B/B2C. Check DNC registry (national + state). Establish internal DNC list. Time-of-day restrictions: 8am–9pm recipient local time. State overlays: Florida Telephone Solicitation Act (FTSA), Oklahoma TCPA, Washington CEMA — broader than federal TCPA.
...
- **Data protection:** No federal omnibus law. State patchwork — operate to the strictest (California CCPA/CPRA). FTC enforces deceptive privacy practices. HIPAA if any customer is a covered entity (need BAAs). GLBA for financial customers. COPPA for under-13.
- **Consumer rights:** Auto-renewal disclosure (CA, NY, IL, NJ, DC, OR). 3-day cooling off for door-to-door sales (FTC rule) — N/A for B2B SaaS but verify state law. CARD Act for credit cards.
- **Sector-specific:**
  ...
  - Financial — TILA, MAP Rule, state mortgage advertising rules; CFPB on UDAAP.
  - Insurance — state-by-state DOI rules.
  - Cannabis — federal Schedule I; per-state advertising rules; payment processor restrictions.
  - Firearms, gambling, payday lending, MLM, adult — restricted use cases per AUP.
- **Local entity:** Delaware C-Corp (assumed primary entity). Sales tax registration in all economic nexus states post-Wayfair ($100K revenue or 200 txns threshold per state — varies). Register as foreign entity in states with physical/employee presence.
...
- **Reverse charge / B2B:** N/A — US doesn't use reverse charge. Use resale/exemption certificates where applicable.
...
- **Refund processing:** Credit card refunds 5–10 business days per Reg E/Z. ACH reversals 1–2 days. Honor 30-day money-back per refund policy doc 05d.

## C. Compliance Frameworks

- **Compliance agent rules:** CCPA/CPRA, VCDPA, CPA, CTDPA, UCPA, TDPSA, OCPA, MCDPA, DPDPA, TCPA, CAN-SPAM, FTC Section 5, COPPA (block under-13), state AI laws (CO AI Act, CA SB 942/AB 2013, UT, TX). SOC 2 Type II by Month 9 — auditor: Prescient Assurance, Schellman, or A-LIGN.
- **Data residency:** No requirement. US-East primary, US-West DR.
- **Cross-border transfers:** Inbound from EU/UK/CH via SCCs + supplementary measures or via DPF (EU-US Data Privacy Framework — self-certify via commerce.gov/DPF). GoFunnelAI self-certifies DPF + UK Extension + Swiss-US DPF by Month 3.
...
- **Breach notification:** Patchwork — CA 72 hours to AG if >500 residents affected; most states "without unreasonable delay." HHS 60 days under HIPAA if applicable. Notify Stripe/processor if payment data.
...
- **Diverging industries:** Insurance lead-gen (huge in US, regulated state-by-state); home services (HVAC, roofing — massive vertical); solar (post-IRA boom but state-specific incentives); legal — PI lead-gen distinct from general; education — for-profit colleges restricted (Gainful Employment rule).
- **Formatting:** MM/DD/YYYY; 12-hour clock; $1,234.56; imperial units default but allow metric.
- **Phone:** +1 NPA-NXX-XXXX. Validate via NANP. Block unallocated NPAs. Toll-free vs geographic — flag toll-free as lower trust for cold outreach.
- **Address:** Street, City, ST ZIP (5 or 9). Validate via USPS API.
- **Banned topics:** Per AUP doc 07a — no cannabis (federal), no firearms FFL, no payday lending, no adult, no MLM, no debt-relief without state license, no "make money online" unless verifiable.

## E. Support Operations

- **Time zone:** US team covers 6am PT – 9pm ET (15-hr business window). Tier-1 chat 24/7 via follow-the-sun handoff to LATAM team (Month 4) and APAC team (Month 8).
- **Language:** EN, ES (Month 6).
- **Moderation:** Section 230 protections; remove illegal content (CSAM via NCMEC reporting, copyright via DMCA 512 takedown — register DMCA agent at copyright.gov).
...
- **Phone support:** +1 toll-free (855 or 888) — provision via Twilio.
...
- **Influencers:** Marketing Twitter/X creators — pursue: Codie Sanchez (operator audience), Sam Parr (My First Million), Greg Isenberg (Late Checkout), Pat Walls (Starter Story), Ben Tossell (no-code).
...
- **Case studies:** 3 case studies needed before scale spend — target: HVAC contractor, B2B SaaS reseller, online course creator.
...
- **Platforms:** All US ad platforms work — Google Ads, Meta, TikTok, LinkedIn, X, Reddit Ads, Pinterest. CRMs — HubSpot, Salesforce, Pipedrive, Close, Zoho, Copper. Calendars — Google, Outlook/M365, Apple iCloud. SMS — Twilio, MessageBird. Voice — Twilio, Vonage. Email — SendGrid, Mailgun, Postmark, AWS SES.
...
- **Local counsel:** Bird & Bird LLP, Fieldfisher, Kemp Little (now Deloitte Legal), or Taylor Wessing for tech/AI; for ASA advertising disputes — Lewis Silkin.
...
- **AI disclosure:** No UK AI Act yet — pro-innovation, sector-led approach (ICO, CMA, Ofcom, FCA each issue guidance). ICO guidance on AI and data protection requires DPIA for high-risk processing. CMA AI Foundation Models report. Transparency obligation: tell users when interacting with AI. Watch Data (Use and Access) Act 2025 + the upcoming AI Bill (consultation closed 2025).
- **Telemarketing:** PECR (Privacy and Electronic Communications Regulations). Automated calls — prior consent required, hard stop. CTPS (Corporate Telephone Preference Service) + TPS for consumers — screen mandatory. ICO fines up to Â£17.5M.
...
- **Data protection:** UK GDPR + DPA 2018. ICO is regulator. Register with ICO and pay data protection fee (Â£40–Â£2,900 based on size).
- **Consumer rights:** Consumer Contracts Regulations 2013 — 14-day cooling-off for distance B2C contracts; SaaS digital content carve-out if consumer consents to immediate supply and acknowledges loss of cancellation right.
- **Sector-specific:** FCA for financial promotions (new s.21 FSMA approval regime for finproms by approved persons — applies to lead-gen for financial products); MHRA for medical device advertising; Solicitors Regulation Authority and Bar Standards Board for legal lead-gen; ASA CAP/BCAP codes for all advertising.
...
- **Tax:** VAT 20% standard. Stripe Tax handles. Register for UK VAT when taxable turnover >Â£90K (from April 2024). MOSS scheme N/A post-Brexit — register directly.
...
- **Reverse charge / B2B:** Reverse charge applies for B2B sales to UK VAT-registered customers if GoFunnelAI is non-UK established — capture and validate VAT number via HMRC API.
- **Fraud patterns:** Authorized push payment (APP) fraud trending; Stripe Radar + 3DS2 mandatory under SCA.
- **Refund:** 14-day statutory; 5–10 business days for card. Honor via standard refund policy.

## C. Compliance Frameworks

- **Compliance agent rules:** UK GDPR, DPA 2018, PECR, Consumer Rights Act 2015, ASA CAP/BCAP, Online Safety Act 2023 (user-to-user services duties — applies if AUP-related content moderation), Equality Act 2010 for non-discrimination in AI outputs.
- **Data residency:** No strict requirement, but UK ICO prefers UK or adequacy-decision countries. Use UK or EU region.
- **Cross-border transfers:** UK adequacy decision for EEA; for US — UK Extension to EU-US DPF (self-certify with US partner if any) or UK IDTA / Addendum to SCCs.
...
- **Language:** EN-GB at launch (separate locale from EN-US — spelling, currency symbol, conventions).
...
- **Diverging industries:** Property (estate agents — distinct from US real estate model; OnTheMarket, Rightmove); tradesmen (Checkatrade, MyBuilder, Rated People); accountants (much higher SME density); private healthcare (Bupa, AXA PPP).
...
- **Time zone:** UK team or shared with EU 9am–6pm GMT/BST.
- **Language:** EN.
...
- **Phone support:** 0800 freephone — provision via Twilio.
...
- **Influencers:** Daniel Priestley, Chris Donnelly, Steven Bartlett (DOAC — premium tier), Eddie Shleyner (B2B copy), Amelia Sordell (LinkedIn personal branding).
...
- **Platforms:** Google, Meta, TikTok, LinkedIn, X — all work. Reddit smaller. Snapchat per audience. ITV/Channel 4 ads via separate brokers (not Funnel-relevant at launch).
...
- **ToS / Privacy Policy:** Bilingual mandatory (EN + FR) — Quebec strictly enforces French via OQLF. Reference PIPEDA + Quebec Law 25 + Alberta PIPA + BC PIPA.
- **AI disclosure:** No federal AI law yet — AIDA (Artificial Intelligence and Data Act) under Bill C-27 stalled; voluntary code of practice for generative AI. Quebec Law 25 requires disclosure of automated decision-making and the right to obtain information about the decision. Disclose AI interaction up-front.
- **Telemarketing:** Unsolicited Telecommunications Rules (CRTC). National DNCL screening required. Express consent for ADADs (Automatic Dialing-Announcing Devices) — incl. AI voice. CRTC fines up to $15K/violation individual, $1.5M corporate.
- **Anti-spam:** CASL (Canada's Anti-Spam Legislation) — strict opt-in consent regime (express or implied within narrow categories). Unsubscribe must be functional for 60 days, processed within 10 days. CRTC enforces; penalties up to $10M.
- **Data protection:** PIPEDA (federal) + Quebec Law 25 (deemed substantially similar but stricter — privacy impact assessments mandatory, data residency considerations, breach notification, automated decision rights). Alberta PIPA & BC PIPA for private-sector intra-provincial.
- **Consumer rights:** Provincial consumer protection acts — Ontario CPA, Quebec Consumer Protection Act (strictest, French-only contracts unenforceable, no auto-renewal without opt-in confirmation), Alberta CPA, BC BPCPA.
...
- **Tax:** GST 5% federal + provincial: HST in ON/NB/NL/NS/PEI 13–15%; QST 9.975% in Quebec; PST in BC/SK/MB. Stripe Tax handles. Quebec QST registration separate from GST. SaaS taxable in most provinces.
...
- **Data residency:** Quebec Law 25 — transfers outside Quebec require privacy impact assessment + comparable protection; effectively pushes hosting to CA-Central-1 (Montreal) for QC data. BC for public-sector data residency (not applicable to us at launch).
- **Cross-border transfers:** PIPEDA permits with comparable protection + accountability; Law 25 stricter — PIA required. Use SCCs-equivalent contractual protections.
- **Subject access:** 30 days standard.
- **Breach notification:** PIPEDA — "real risk of significant harm" trigger, notify OPC and individuals; Quebec — 72 hours functional standard.
- **Industry overlay:** Bilingual UI obligation for Quebec consumers.

## D. Content & Localization

- **Language:** EN-CA + FR-CA at launch (Bill 96 — businesses serving Quebec must offer French equivalent of equal quality). FR-CA distinct from FR-FR (Quebec terminology).
...
- **Diverging industries:** Mortgage brokers (provincial licensing; FSRA in Ontario, AMF in Quebec); cannabis (legal federally — but advertising tightly restricted under Cannabis Act); insurance (provincial); resource/mining lead-gen niche.
...
- **Time zone:** Pacific to Newfoundland — 4.5 hour spread. Share with US team during overlap.
- **Language:** EN, FR-CA.
...
- **Ad creative:** Native EN-CA + FR-CA (NOT translated FR-FR — Quebec audience rejects France French).
- **Influencers:** Dan Martell (SaaS Academy — Canadian), Anthony Vicino (creator), Pat Flynn (CA roots), Quebec — Hubert Palan, Mathieu LaferriÃ¨re.
...
- **Affiliates:** PartnerStack (Canadian company — strong fit), Impact.

## H. Integration Status

- **Platforms:** Google, Meta, TikTok, LinkedIn — all work. Snap, Reddit minor.
...
- **AI disclosure:** No AI Act — voluntary AI Ethics Principles. Mandatory guardrails for high-risk AI proposed (Sept 2024 paper). Disclose AI interaction. Watch Privacy Act reform 2025–26 (automated decisions disclosure rules in tier-1 reforms).
- **Telemarketing:** Do Not Call Register Act 2006 — screen DNCR; consent required for marketing calls. ACMA enforces. Time-of-day restrictions.
- **Anti-spam:** Spam Act 2003 — consent (express or inferred) required, identification, unsubscribe within 5 business days. Fines up to AU$2.2M/day.
...
- **Consumer rights:** Australian Consumer Law (ACL) — consumer guarantees cannot be excluded; B2B if value <AU$100K or ordinary use also covered. 14-day cooling-off for unsolicited consumer agreements (not most SaaS).
...
- **Primary rail:** Stripe (AUD). PayPal secondary. PayTo (NPP — New Payments Platform) by Month 9 for direct debit.
...
- **Reverse charge / B2B:** Yes — collect and verify ABN via ABR API.
- **Fraud patterns:** Lower fraud than US; some crypto-adjacent fraud rings.
- **Refund:** ACL remedies — repair/replace/refund for major failures; 30-day policy honored.

## C. Compliance Frameworks

- **Compliance agent rules:** Privacy Act + APPs, Spam Act 2003, DNC Register Act, ACL, ASIC DDO for financial verticals.
- **Data residency:** No strict requirement, but cross-border disclosure has accountability rules — APP 8.
- **Cross-border transfers:** APP 8 — reasonable steps to ensure overseas recipient handles per APPs, or accountability remains.
- **Subject access:** 30 days; no fee for reasonable request.
- **Breach notification:** Notifiable Data Breaches — "eligible data breach" with likely serious harm; notify OAIC and affected individuals "as soon as practicable."
...
- **Diverging industries:** Trades (HIA-licensed builders, hipages platform); mortgage brokers (different from US — broker-dominant market); migration agents (MARA-registered — restricted advertising).
...
- **Banned topics:** Gambling — tightly regulated, federal + state licenses required; therapeutic goods — TGA restrictions; tobacco/vapes — strict.

## E. Support Operations

- **Time zone:** AEST/AEDT — APAC team or shared with Asia team 9am–6pm Sydney.
- **Language:** EN.
...
- **ToS / Privacy Policy:** Spanish-language Aviso de Privacidad (mandatory format per LFPDPPP) — simplified, short, and integral versions; point of collection notice. Mexican consumer protection (PROFECO) disclosures.
...
- **Telemarketing:** REPEP (Registro PÃºblico para Evitar Publicidad) operated by PROFECO — screen mandatory; time restrictions; ID disclosure.
...
- **Data protection:** LFPDPPP (Ley Federal de ProtecciÃ³n de Datos Personales en PosesiÃ³n de los Particulares) + Regulation. INAI regulator (now restructured following reform — successor body has same functions). Aviso de Privacidad strict format. ARCO rights (Access, Rectification, Cancellation, Opposition + Revocation of consent).
- **Consumer rights:** Federal Consumer Protection Law (LFPC) — PROFECO. Adhesion contract registration potentially required for B2C; B2B SaaS generally exempt but verify by counsel.
- **Sector-specific:** CNBV for fintech (Ley Fintech 2018 — registration if regulated activity); COFEPRIS for medical; financial advertising rules.
- **Local entity:** Not required for cross-border SaaS, but RFC (tax ID) registration may be required for VAT collection on digital services to Mexican residents (IVA digital services rules — non-resident providers must register since 2020).

## B. Payment Rails

- **Primary rail:** Stripe (MXN) + OXXO (cash voucher network — Stripe supports), SPEI (bank transfer). PayPal secondary. Local cards via Stripe.
...
- **Invoice format:** CFDI 4.0 (Comprobante Fiscal Digital por Internet) via SAT-authorized PAC (Proveedor Autorizado de CertificaciÃ³n). Requires customer RFC, fiscal regime, postal code. GoFunnelAI integrates with a PAC like Facturama, KonfÃ­o FacturaciÃ³n, or Edicom by Month 3.
- **Reverse charge / B2B:** N/A — IVA standard.
...
- **Subject access:** ARCO requests — 20 business days response.
...
- **Language:** ES-MX at launch (NOT ES-ES — Mexican Spanish is distinct: "ustedes" not "vosotros," local idioms, lower formality).
...
- **Banned topics:** Cannabis pending federal regs; gambling — SEGOB license; firearms — federal restriction.

## E. Support Operations

- **Time zone:** CST Mexico (UTC-6). LATAM team covers MX + Brazil + Spanish-speaking SA 8am–8pm.
...
- **Platforms:** Google, Meta, TikTok dominant; LinkedIn growing; WhatsApp Business essential (Meta integration — bake into RevTry).
...
- **Owner:** LATAM Country Lead — Mexico focus (CDMX or remote, hire Month 5).
...
- **Local counsel:** Pinheiro Neto Advogados; Mattos Filho; Demarest; TozziniFreire; Veirano; for AI/data specialty — Opice Blum.
- **ToS / Privacy Policy:** Portuguese (PT-BR) mandatory. LGPD-aligned. CDC (CÃ³digo de Defesa do Consumidor) disclosures.
- **AI disclosure:** PL 2338/2023 AI bill advancing (Senate passed Dec 2024) — risk-based framework similar to EU AI Act. ANPD (Autoridade Nacional de ProteÃ§Ã£o de Dados) issued AI guidance. Disclose AI interactions; impact assessment for high-risk.
- **Telemarketing:** NÃ£o Me Perturbe registry — screen mandatory; ANATEL rules. State-level laws (e.g., SP) ban robocalls without consent. Caller ID required.
...
- **Consumer rights:** CDC very strong — 7-day right of withdrawal for distance contracts (Art 49) — applies to SaaS B2C. PROCON state enforcement. Class actions easy.
- **Sector-specific:** BACEN for payment/fintech; ANVISA for medical; OAB (lawyer ad rules — restrictive); CVM for investment products.
- **Local entity:** Not required for SaaS export, but practical for tax — ISS (municipal service tax) collection complex without Brazilian entity. CNPJ helpful. Consider Marketplace model or use Stripe BR (which acts via local entity).

## B. Payment Rails

- **Primary rail:** Stripe BR (BRL) — installments (parcelado), Boleto BancÃ¡rio, Pix (instant). Pix critical — >50% of digital payments. PayPal secondary.
- **Currency:** BRL. PPP tier: 0.40x US.
- **Tax:** Federal + state + municipal mess. SaaS classified as software service (ISS municipal 2–5%) typically. Recent tax reform (EC 132/2023) introduces IBS/CBS dual-VAT — transition 2026–2033. PIS/COFINS for residents. For non-resident: increased withholdings.
- **Invoice format:** NFS-e (Nota Fiscal de ServiÃ§o eletrÃ´nica) for services — municipal format, varies by city. Integrate via providers like NFE.io, Migrate, Omie, or eNotas. Without local entity, customer self-withholds or uses purchase from abroad classification.
- **Reverse charge / B2B:** N/A in same form; withholdings (IRRF, CIDE, ISS) on cross-border payments may apply 15–25%.
- **Fraud patterns:** High chargeback risk; CPF validation essential; installment fraud common — limit parcelado on new accounts.
- **Refund:** Art 49 CDC — 7 days no-questions for distance B2C; honor immediately.
...
- **Cross-border transfers:** LGPD Article 33 — adequacy decisions (none yet by ANPD), SCCs/BCRs, specific consent. ANPD published standard contractual clauses (2023).
- **Subject access:** 15 days response for data subject requests; free.
- **Breach notification:** "Reasonable time" — ANPD considers 2 business days. Notify ANPD + data subjects.
- **Industry overlay:** None at launch.

## D. Content & Localization

- **Language:** PT-BR at launch (distinct from PT-PT — vocabulary and tone differ).
- **Cultural adaptation:** Trust signals — Reclame Aqui rating (huge in BR); "Empresa Verificada"; SSL badges visible; testimonials with photo + first name + state.
- **Diverging industries:** Infoprodutos (digital courses massive — Hotmart ecosystem); coaches; corretores de imÃ³veis; advogados (subject to OAB ad rules); MEI/PJ services boom.
...
- **Banned topics:** Gambling (federal — sports betting now regulated under Bets law 2023, but other gambling restricted); medical claims; OAB lawyer advertising heavily restricted.

## E. Support Operations

- **Time zone:** BRT (UTC-3). LATAM team 8am–8pm.
- **Language:** PT-BR primary, ES + EN backup.
- **Moderation:** Marco Civil da Internet — judicial takedown standard; specific obligations for CSAM, hate speech.
- **Holidays:** Ano Novo, Carnaval (Mon+Tue before Ash Wed — effectively shutdown Fri–Wed), Sexta-feira Santa, Tiradentes (Apr 21), Dia do Trabalho (May 1), Corpus Christi (movable), IndependÃªncia (Sep 7), Nossa Senhora Aparecida (Oct 12), Finados (Nov 2), ProclamaÃ§Ã£o da RepÃºblica (Nov 15), ConsciÃªncia Negra (Nov 20), Natal. Municipal holidays add — SÃ£o Paulo Jan 25, Rio Apr 23.
...
- **DIDs:** Twilio BR DIDs require special verification (CPF/CNPJ + address proof) — start at Month 2.
...
- **Affiliates:** Hotmart (dominant BR platform — integration valuable), Eduzz, Monetizze.
...
- **Owner:** Brazil Country Lead (SÃ£o Paulo, hire Month 3 — PT-BR critical).
...
- **Local counsel:** Hengeler Mueller; Noerr; Gleiss Lutz; Hogan Lovells Munich; Taylor Wessing Germany; for data — SKW Schwarz, Bird & Bird DE.
- **ToS / Privacy Policy:** German (DE) mandatory for German consumers. AGB (Allgemeine GeschÃ¤ftsbedingungen) strict — BGB Â§Â§ 305–310 limits enforceability. Impressum legally required (TMG Â§5 / DDG Â§5) — name, address, contact, register info, VAT ID — on every site.
- **AI disclosure:** EU AI Act applies — phased dates from Feb 2025 (prohibited practices, AI literacy) through Aug 2026 (GPAI) and Aug 2027 (high-risk). Transparency obligations: tell users they're interacting with AI; mark AI-generated content (audio/image/video/text). GoFunnelAI is a "limited risk" AI system under most use; flag any high-risk (e.g., scoring in employment/credit) — those would require conformity assessment.
- **Telemarketing:** UWG (Gesetz gegen den unlauteren Wettbewerb) Â§7 — prior express consent for any cold call to consumers; B2B requires "presumed consent" (sachlicher Bezug + interest). Fines up to â‚¬300K (Bundesnetzagentur). AI voice — strict consent.
- **Anti-spam:** UWG Â§7(2) — express consent for email marketing (double opt-in industry standard); B2B same standard. CCPA-style "soft opt-in" narrow.
...
- **Consumer rights:** BGB Â§312g — 14-day right of withdrawal for distance contracts; digital content carve-out if customer explicitly consents to immediate performance and waives withdrawal right (acknowledgment must be clear and demonstrable). Verbraucherzentrale active.
- **Sector-specific:** BaFin for financial; BfArM for medical devices; UWG for advertising; competitor cease-and-desist (Abmahnung) culture — small UWG violations attract attorney letters.
- **Local entity:** Not required for SaaS export, but GDPR Article 27 EU Representative required if no EU establishment (engage VeraSafe / EDPO / Prighter). VAT-OSS via Ireland or another EU member possible — see Section B.

## B. Payment Rails

- **Primary rail:** Stripe (EUR) — cards, SEPA Direct Debit, Sofort, Giropay (deprecating), Klarna, PayPal. SEPA critical for B2B.
...
- **Invoice format:** Strict requirements (UStG Â§14) — full address, USt-IdNr (VAT ID), invoice date, sequential number, quantity/description, net + tax + gross, payment terms. E-invoicing mandatory for B2B by 2028 (X-Rechnung / ZUGFeRD format).
- **Reverse charge / B2B:** Yes — collect customer VAT ID, validate via VIES, apply reverse charge for EU B2B outside DE.
...
- **Compliance agent rules:** GDPR + BDSG, EU AI Act, ePrivacy/TTDSG (cookie consent), UWG, BGB consumer law, TMG/DDG (Impressum), DSA (Digital Services Act) — limited applicability unless intermediary, DGA, NIS2 (depending on classification).
- **Data residency:** No strict GDPR residency mandate, but BfDI guidance prefers EU/EEA. German public sector / health sector demands DE residency — out of scope for Year 1.
...
- **Cultural adaptation:** Trust badges — TÃœV, Trusted Shops, eKomi, German hosting badge ("Made in Germany," "Server in Deutschland"); Impressum visible; data protection assurance prominent; testimonials with full disclosure; no over-claims (Abmahnung risk).
- **Diverging industries:** Handwerker (skilled trades — Meisterpflicht; Handwerksrolle registration); Steuerberater (tax advisors — strict advertising rules under StBerG); Heilpraktiker; KMU (Mittelstand) focus; insurance brokers Â§ 34d GewO.
...
- **Time zone:** CET/CEST. EU team 9am–6pm.
- **Language:** DE, EN.
...
- **DIDs:** Twilio DE local (require local address verification — start 4 weeks pre-launch).
...
- **Platforms:** Google, Meta, LinkedIn (strong DACH B2B), Xing (DACH-native professional — integrate if B2B push). TikTok growing. WhatsApp Business big.
...
- **Local counsel:** Gide Loyrette Nouel; Bredin Prat; Cleary Gottlieb Paris; Hogan Lovells Paris; for data — De Gaulle Fleurance, August Debouzy.
- **ToS / Privacy Policy:** French (FR) required for consumer-facing — Loi Toubon mandates French language. CGV (Conditions GÃ©nÃ©rales de Vente) for B2C + CGU.
- **AI disclosure:** EU AI Act + French CNIL guidance on AI. Strong CNIL enforcement on AI projects — sandbox program for pilots. Transparency obligations same as EU. France NumÃ©rique 2030 plan.
- **Telemarketing:** Loi Naegelen (loi du 24 juillet 2020) + Bloctel registry — strict opt-out registry, mandatory screening. Time windows: 10am–1pm and 2pm–8pm weekdays only; banned weekends/holidays (since 1 March 2023). Fines up to â‚¬375K/violation by DGCCRF.
- **Anti-spam:** LCEN (Loi pour la Confiance dans l'Ã‰conomie NumÃ©rique) — opt-in for B2C email/SMS; B2B soft opt-in possible for professional address with topical relevance. Unsubscribe mandatory.
- **Data protection:** GDPR + Loi Informatique et LibertÃ©s (since 1978, updated). CNIL regulator — strong enforcement; large fines (Google, Meta, Amazon).
- **Consumer rights:** Code de la consommation — 14-day right of withdrawal for distance B2C; digital content can waive with explicit consent + acknowledgment. DGCCRF enforces.
...
- **Primary rail:** Stripe (EUR) — Cartes Bancaires (Groupement CB — critical for FR cards), SEPA, Bancontact, PayPal. iDEAL not (that's NL).
- **Currency:** EUR. PPP tier: 0.90x US.
- **Tax:** TVA 20% standard. OSS for cross-border.
- **Invoice format:** Code gÃ©nÃ©ral des impÃ´ts requirements — SIREN/SIRET of issuer (if French entity), VAT number, complete addresses, sequential number, description, breakdown by VAT rate. E-invoicing (Chorus Pro for B2G; B2B mandate phased 2026–2027 via Factur-X / PDP).
- **Reverse charge / B2B:** Yes — collect/validate EU VAT ID.
...
- **Data residency:** No strict mandate generally; public sector — SecNumCloud certification often required (out of scope Year 1).
- **Cross-border transfers:** Same as EU — SCCs / DPF.
- **Subject access:** 1 month.
- **Breach notification:** 72 hours to CNIL.
- **Industry overlay:** Health data — HDS (HÃ©bergement de DonnÃ©es de SantÃ©) certification required for any healthcare customers (defer to Year 2).

## D. Content & Localization

- **Language:** FR-FR at launch (NOT FR-CA).
- **Cultural adaptation:** Loi Toubon — all customer-facing French; English permitted only when accompanied by French. Trust signals — Trustpilot FR, "Made in France" if applicable, RGPD compliance badge, "DonnÃ©es hÃ©bergÃ©es en Europe." Formal vous-form initially; tu-form possible if young/casual brand.
...
- **Phone:** +33; 06/07 mobile; 01–05 geographic.
...
- **Holidays:** Jour de l'An (Jan 1), Lundi de PÃ¢ques, FÃªte du Travail (May 1), Victoire 1945 (May 8), Ascension, Lundi de PentecÃ´te, FÃªte Nationale (Jul 14), Assomption (Aug 15), Toussaint (Nov 1), Armistice (Nov 11), NoÃ«l. August generally low activity — entire FR market slow Jul 14–Aug 31.
...
- **DIDs:** Twilio FR DIDs (require local address verification — Arcep rules).

## G. Marketing

- **Ad creative:** Native FR-FR; tone — articulate, slightly intellectual, avoid US hype.
...
- **Platforms:** Google, Meta, LinkedIn, TikTok. Local — Welcome to the Jungle for hiring (not relevant); Doctolib for medical (out of scope).
...
- **Local counsel:** Cyril Amarchand Mangaldas; Shardul Amarchand Mangaldas; AZB & Partners; Khaitan & Co; Nishith Desai Associates (tech specialty); for data/tech — Ikigai Law, Spice Route Legal.
...
- **Telemarketing:** TRAI Telecom Commercial Communications Customer Preference Regulations (TCCCPR 2018) + DLT (Distributed Ledger Technology) registration for all SMS senders; header + template pre-approval. DND (Do Not Disturb) registry mandatory. Strict — telecom operators block non-registered traffic. For voice — same DLT regime.
- **Anti-spam:** TCCCPR for SMS/voice; for email — Consumer Protection Act + IT Act. Soft regulation but opt-out required.
- **Data protection:** DPDP Act 2023 (Digital Personal Data Protection Act) — rules pending notification as of late 2025. Once in force: consent, notice, data fiduciary obligations, Data Protection Board (DPB). Children = under 18. Significant Data Fiduciary may have stricter duties.
- **Consumer rights:** Consumer Protection Act 2019 + E-Commerce Rules 2020 — grievance redressal officer mandatory, response within 48 hours / resolution within 30 days. Cooling-off varies by goods; SaaS — refund per contract.
...
- **Local entity:** Not required for SaaS export, but Equalisation Levy 2% on non-resident e-commerce supply to India was phased out August 2024 — now subject to broader BEPS rules. GST registration for non-resident OIDAR provider required when supplying digital services to Indian customers. Appoint Authorized Representative.

## B. Payment Rails

- **Primary rail:** Stripe India onboarding still limited — use Razorpay (UPI, cards, netbanking, wallets) as primary; Stripe global for international cards; PayPal as backup. UPI dominant — must support.
...
- **Reverse charge / B2B:** Yes — collect GSTIN, validate via GST portal.
- **Fraud patterns:** High volume of failed cards (issuer declines common); UPI more reliable; subscription challenges since RBI 2021 e-mandate rules — many cards reject recurring (use UPI Autopay).
- **Refund:** 5–7 days for UPI; cards similar; honor 30-day policy. RBI sets refund timelines for payment failures.
...
- **Data residency:** Sector-specific localization (RBI payment data — full localization in India; SEBI for capital markets data). DPDP Act includes whitelist mechanism — government can restrict transfer to specific countries.
...
- **Breach notification:** CERT-In 6-hour incident reporting rule (2022 directive) — applies broadly to body corporates; very tight. DPB notification under DPDP per rules.
- **Industry overlay:** Fintech/payments — RBI sandbox; data localization heavy.

## D. Content & Localization

- **Language:** EN (Indian English) at launch; Hindi UI by Month 6; Tamil/Telugu/Bengali/Marathi/Gujarati phased Year 2.
- **Cultural adaptation:** Trust signals — Razorpay/payment logos, GSTIN visible, ISO 27001; testimonials reference Tier-1/Tier-2 cities; entrepreneur respect tone; family-business friendly; numeric tradition — use lakh/crore (â‚¹1,00,000 / â‚¹1,00,00,000) for INR amounts.
- **Diverging industries:** EdTech (huge — coaching institutes, test prep); D2C e-comm boom; insurance agents (huge POS network); real estate brokers (RERA registration); financial planners (SEBI registration).
...
- **Time zone:** IST. APAC team or India local — 9am–9pm IST.
- **Language:** EN, Hindi (Month 6); other regional follow.
- **Moderation:** IT Rules 2021 — Grievance Officer, Resident Grievance Officer (for Significant Social Media Intermediaries — not us at launch); takedown timelines.
- **Holidays:** Republic Day (Jan 26), Holi (varies), Independence Day (Aug 15), Gandhi Jayanti (Oct 2), Diwali (varies), Christmas. Many regional optional holidays — Eid, Pongal, Onam, Durga Puja, Ganesh Chaturthi.
...
- **Platforms:** Google, Meta, LinkedIn, X dominant; Sharechat (regional language); Moj; ShareChat for vernacular. WhatsApp Business absolutely critical — 70%+ business comms. Truecaller integration valuable for caller ID trust.
- **Stripe:** Limited; use Razorpay primary.
- **Calendar:** Google dominant; M365 enterprise.

## I. Launch Phasing

- **60-day:** Counsel review DPDP readiness; CERT-In 6-hour incident process; Grievance Officer designated; Razorpay merchant onboarding (~3–4 weeks); OIDAR GST registration; DLT registration for SMS templates (via Razorpay or Karix); WhatsApp Business API verification.
...
- **Owner:** India Country Lead (Bangalore or Bombay, hire Month 4 — local context required).
...
- **Local counsel:** Nishimura & Asahi; Mori Hamada & Matsumoto; Anderson Mori & Tomotsune; Nagashima Ohno & Tsunematsu; for tech/data — TMI Associates, Atsumi Sakai.
- **ToS / Privacy Policy:** Japanese (JA) required for consumer-facing — Act on Specified Commercial Transactions (ç‰¹å•†æ³•) mandates clear seller info disclosure (legal name, address, phone, representative, return policy) for online commerce. Privacy notice per APPI (å€‹äººæƒ…å ±ä¿è­·æ³•).
- **AI disclosure:** AI Bill 2025 (æ³•å¾‹) — Japan's framework-level AI law passed May 2025 — broad principles, light touch, METI/PPC guidance for specifics. Transparency expectation. PPC has AI guidance. Generative AI training data — copyright considerations under Article 30-4 of Copyright Act.
- **Telemarketing:** Act on Specified Commercial Transactions — prohibits repeat solicitation after refusal; pre-call disclosure required. JIAA self-regulation for online advertising. No central DNC registry as comprehensive as US, but consumer affairs agency strong.
- **Anti-spam:** Act on Regulation of Transmission of Specified Electronic Mail — opt-in required for marketing email; sender ID required; unsubscribe must work. Fines + criminal penalties.
...
- **Consumer rights:** Specified Commercial Transactions Act + Consumer Contract Act — cooling-off in specified categories (door-to-door, telemarketing); online B2C SaaS usually contract-governed but standard form clauses void if unilaterally disadvantageous. Important — clear cancellation flow legally required.
- **Sector-specific:** FSA for financial; MHLW/PMDA for medical; JFTC for advertising; Bar Association for legal.
- **Local entity:** Not required for SaaS export, but business operations with continuous presence may trigger KK (Kabushiki Kaisha) or branch registration. Consumption Tax registration required when taxable sales exceed JPY 10M annually (over 2 years prior) — foreign digital services rules apply. Appoint domestic agent under APPI 2022 reform when targeting Japanese residents.

## B. Payment Rails

- **Primary rail:** Stripe (JPY) — cards, Konbini (convenience store cash), bank transfers. PayPay (mobile wallet) via Stripe in beta. PayPal secondary. Local card brands JCB critical (Stripe supports).
- **Currency:** JPY. PPP tier: 0.85x US (but psychological pricing — round JPY amounts: Â¥4,980 vs $49.80).
- **Tax:** Consumption Tax 10% (8% reduced for some food/news — not us). Foreign digital service providers must register under "consumption tax on cross-border B2C digital services" rules. B2B reverse charge for registered customers.
- **Invoice format:** Qualified Invoice System (é©æ ¼è«‹æ±‚æ›¸) since Oct 2023 — must include qualified invoice issuer registration number for customers to claim input credit. Register with NTA as Qualified Invoice Issuer.
- **Reverse charge / B2B:** Yes — collect invoice issuer number, apply reverse charge for B2B if applicable.
...
- **Cross-border transfers:** APPI Article 28 — consent + provision of info on recipient country + protection equivalent. Japan-EU mutual adequacy.
- **Subject access:** Generally without undue delay; APPI 2022 sets request handling expectations.
- **Breach notification:** APPI 2022 — report to PPC promptly (within ~3–5 days for preliminary) and to individuals when high risk.
- **Industry overlay:** Number Act (My Number) — if any government ID handling, strict rules — not relevant at launch.

## D. Content & Localization

- **Language:** JA at launch (Month 4 — JA adds a quarter to launch).
- **Cultural adaptation:** Trust signals — Privacy Mark (Pãƒžãƒ¼ã‚¯ — JIPDEC), TRUSTe Japan, JIS Q 15001 references, ISMS, Tokutei ShÅtorihiki disclosure block prominent, "é‹å–¶ä¼šç¤¾" (operating company) block on every page; testimonials with company name + role (more institutional than personal); formal tone (æ•¬èªž); avoid hype.
- **Diverging industries:** Real estate (å®…å»ºå£« license required for property advertising); insurance agents; tax/accounting practitioners; cram schools (juku — big EdTech segment); restaurant owners (huge SMB segment); local services (Koukoku/Tokutei rules).
...
- **DIDs:** Twilio JP DIDs require local entity verification — start at Month 2.
...
- **Influencers:** Manabu Bannai (ãƒžãƒŠãƒ– — blog/YT entrepreneur), Mocchi (mocchi blog), Daigo (mentalist — broad), Sho Tanaka (Twitter business), Yusuke Wada, b2b — Atsumi Suzuki.
- **Communities:** Slack communities — Indie Hackers Japan, Startup Weekend Japan; Open Network Lab; J-Startup; ITmedia; SaaS.tech.
- **PR:** TechCrunch Japan (closed 2022 but JP outlets reborn — BridgeTokyo, The Bridge, ITmedia NEWS), Nikkei XTech, ASCII, IT mediaãƒ“ã‚¸ãƒã‚¹, MarkeZine, Forbes Japan.
...
- **Platforms:** Google, Meta, X (Japan #2 X market), LINE Ads + LINE Official Account (essential — bake into RevTry/CRM), Yahoo! Japan Ads (still relevant — Yahoo JP dominant portal), TikTok growing. LinkedIn weak in JP — use Wantedly for hiring (N/A to product).
- **Communication:** LINE > WhatsApp in Japan — must integrate LINE Official Account messaging.
- **Stripe:** Full JP support.
- **Calendar:** Google dominant in startups; M365 enterprise; some legacy users on Cybozu Garoon / SaibÅzu — Garoon integration valuable for enterprise.
...
- **Owner:** Japan Country Lead (Tokyo, hire Month 6 — bilingual JA/EN essential).
...
**Why not Year 1:** PIPL (Personal Information Protection Law) is comparable to GDPR in scope but pairs with CSL + DSL — and the data residency / Critical Information Infrastructure rules effectively require local entity, ICP license, and in-country hosting on a CAC-approved provider. CAC security assessment for outbound data transfers can take 6–12 months. State Secrets Law and Counter-Espionage Law create unbounded compliance risk for an AI product that processes communications data. Generative AI services targeting PRC users require approval under the Interim Measures for Generative AI Services — algorithm filing with CAC. Foreign payment rails are restricted; would require Alipay/WeChat Pay integration through a PRC entity. Cumulative cost + risk + revenue ceiling for an early-stage company points to "no" until at least Year 3 and only via a separate PRC subsidiary or a licensee model. **Geo-restrict signup. Block PRC IPs.**
...
|---|---|---|---|---|
| US | US Country Lead | Month 0 (CEO interim) | Cooley + Klein Moynihan Turco | — |
| UK | UK & Ireland Lead | Month 4 | Bird & Bird | VeraSafe (Art 27) |
| CA | Canada Lead | Month 5 | Osler + Fasken (QC) | — |
| AU | ANZ Lead | Month 6 | Gilbert + Tobin | — |

...
1.3 **"Account"** means your registered user profile with the Service.

1.4 **"Subscription"** means a paid plan to access the Service, billed monthly or annually through PayPal.

1.5 **"Free Tier"** means access to the Service at no cost, with feature and usage limits set by us.

1.6 **"Pro Boost"** means the 7-day promotional access period with expanded features described at sign-up.

1.7 **"Generated Content"** means any text, image, video, audio, script, page, sequence, or other output produced by the Service's AI features in response to your prompts, inputs, or selections.
...
1.11 **"Third-Party Integration"** means any third-party service, platform, or API that you connect to the Service (e.g., email/SMS gateways, payment processors, CRMs, ad platforms, analytics tools).

---

## 2. Account Terms

2.1 **Eligibility.** You must be at least 16 years old to use the Service. If you use the Service on behalf of an organization, you represent that you are authorized to bind that organization.
...
2.5 **Sanctions and export controls.** You may not use the Service if you are located in, ordinarily resident in, or a national of a country or region subject to comprehensive U.S. trade sanctions, or if you appear on any U.S. government restricted-party list.

---

## 3. Acceptable Use

3.1 Your use of the Service is governed by our **Acceptable Use Policy** (`05c-acceptable-use-policy.md`), which is incorporated by reference into these Terms.

3.2 Without limiting the AUP, you agree not to:

(a) use the Service to violate any law, regulation, or third-party right;
(b) send communications to recipients who have not provided the consent required by applicable law (including TCPA, CAN-SPAM, CASL, GDPR/ePrivacy, LGPD, POPIA, DPDP, and equivalent laws);
(c) misrepresent the source or sponsor of any Published Content;
(d) attempt to reverse engineer, scrape at scale, or interfere with the Service;
(e) use the Service to train competing AI models;
(f) circumvent rate limits, usage limits, or access controls.

3.3 We may suspend or terminate access for violations under Section 11.

---

## 4. Subscriptions, Free Tier, and Pro Boost

4.1 **Free Tier.** Free Tier access is provided "as is," is subject to feature/usage caps disclosed in the Service, and carries **no service level commitment** (see Section 9.2).

4.2 **Pro Boost.** The 7-Day Pro Boost grants expanded access for 7 days from activation. At the end of the Pro Boost, your Account reverts to the Free Tier unless you have subscribed to a paid plan.

4.3 **Paid Subscriptions.** Paid plans range from $49 to $997 per month (or annual equivalents) and are billed through **PayPal**. Pricing, features, and limits are described at the point of sale and may be updated under Section 14.

4.4 **Usage-based fees.** Some features (notably RevTry voice minutes, premium model overages, and outbound messaging volume) are billed on a usage basis on top of the base Subscription. Pricing per unit is shown in the Service before consumption.

4.5 **Auto-renewal.** Subscriptions renew automatically until canceled. You can cancel at any time from your Account; cancellation stops future renewals and does not generate a refund except as described in `05d-refund-policy.md`.

4.6 **Taxes.** Listed prices are exclusive of taxes (VAT, GST, sales tax, etc.) unless stated otherwise. You are responsible for applicable taxes; we will collect and remit where required by law.

4.7 **Currency.** Prices are denominated in U.S. dollars unless we display a local price. PayPal may convert at its rates.
...
5.1 **AI output is a draft, not a final product.** The Service uses generative AI models to produce drafts. AI output can be inaccurate, misleading, biased, outdated, infringing, or non-compliant with laws applicable to your business, audience, or jurisdiction. **You are solely responsible for reviewing, editing, fact-checking, and validating all Generated Content before publishing, sending, transmitting, or otherwise using it.**

5.2 **Your review obligation.** Before you cause any Generated Content to become Published Content, you must:

(a) review the content for accuracy, legality, and suitability for your audience;
(b) confirm you have all rights and consents needed to publish or send it;
(c) confirm it complies with all laws, regulations, platform rules, and industry codes that apply to you (including consumer protection, advertising, marketing, telemarketing, anti-spam, healthcare, financial promotion, securities, gambling, alcohol/cannabis, employment, fair housing, fair lending, accessibility, data protection, intellectual property, and tax laws); and
(d) where applicable, obtain professional review (medical, legal, financial, regulatory) before publishing.
...
6.1 **Billing through PayPal.** By subscribing, you authorize PayPal to charge your selected payment method on a recurring basis until you cancel.

6.2 **Failed payments.** If a payment fails, we may suspend paid features, retry the charge, and/or downgrade your Account to the Free Tier. You remain responsible for any unpaid amounts.

6.3 **Price changes.** We may change pricing for new billing periods with at least 30 days' notice (email and in-product). Continued use after the new price takes effect constitutes acceptance.

6.4 **Refunds.** Refunds are governed by `05d-refund-policy.md`. EU/UK consumer withdrawal rights are preserved as described in that policy.

6.5 **Chargebacks.** If you initiate a chargeback we believe is improper, we may suspend your Account and pursue the disputed amount plus reasonable costs. See `05d-refund-policy.md` Section 5.
...
## 8. Data Ownership, Data Protection, and Third Parties

8.1 **Your data is yours.** You own your Account data, your lead and contact data, and your User Content. We process it as a service provider / processor on your behalf, as described in our **Privacy Policy** (`05b-privacy-policy.md`).

8.2 **Data export.** You may export Account data at any time during your Subscription and for 30 days after cancellation, in commonly used formats.
...
9.1 We will use commercially reasonable efforts to keep the Service available, but the Service is provided **"as is"** and **"as available."**

9.2 **No SLA on Free Tier or Pro Boost.** No uptime commitment or service credits apply to the Free Tier or Pro Boost.

9.3 **Paid plans** may include uptime targets or service credits described in a separate SLA document linked from your plan page. Absent such a document, no SLA applies.

9.4 We may perform maintenance, deploy updates, modify features, and impose reasonable rate limits. We will provide advance notice for planned downtime where practical.

9.5 **Third-party dependencies.** The Service relies on third-party infrastructure (cloud hosting, AI model providers, messaging gateways, payment processors). Outages or changes in those providers may affect the Service; we are not liable for them beyond using reasonable efforts to mitigate.
...
10.5 **Allocation of risk.** You acknowledge that these limits are an essential element of the bargain and that without them the fees would be materially higher.
...
12.6 **Jurisdictional adjustments.** If you reside in the EU, UK, Brazil, India, Canada, South Africa, or another jurisdiction where mandatory consumer law overrides arbitration or the class waiver, those mandatory laws apply to the extent required. Nothing in this Section deprives you of the protection of mandatory provisions of the law of your country of habitual residence.

---

## 13. Governing Law

13.1 These Terms are governed by the laws of the **State of Delaware, USA**, without regard to conflicts of law principles. The UN Convention on Contracts for the International Sale of Goods does not apply.

13.2 Subject to Section 12 (Arbitration), the state and federal courts located in **New Castle County, Delaware** have exclusive jurisdiction over any claim not subject to arbitration, and you consent to personal jurisdiction there.

13.3 **Mandatory local law.** If you are a consumer, the courts and law of your country of habitual residence may apply to the extent required by mandatory local law.

---

## 14. Modifications

14.1 We may update these Terms. For material changes, we will provide at least 30 days' advance notice by email and/or in-product banner before the change takes effect. Non-material changes take effect when posted.
...
15.3 **Assignment.** You may not assign these Terms without our written consent. We may assign these Terms in connection with a merger, acquisition, reorganization, or sale of assets.

15.4 **Severability.** If any provision is held unenforceable, the remaining provisions remain in effect.
...
15.9 **English controls.** These Terms are provided in English. Translations are for convenience only; the English version controls.

15.10 **Headings.** Headings are for convenience only and do not affect interpretation.

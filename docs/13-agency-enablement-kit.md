...
> **Audience:** Agency owners evaluating GoFunnelAI, our partnerships team, the agency-facing eng/CS pods.
...
2. **Our COGS scales beautifully.** One $997/mo agency seat serves ~50 client sub-accounts, so the agency's effective gross margin is in the 70–90% range. That's the number that closes the deal.
...
- [Section 1 — Agency Sales Deck (15 slides)](#section-1--agency-sales-deck)
- [Section 2 — Client Onboarding Checklist (5 steps)](#section-2--client-onboarding-checklist)
- [Section 3 — Certification Course: "GoFunnelAI for Agencies"](#section-3--certification-course-funnelai-for-agencies)
- [Section 4 — Sub-Account Architecture (Engineering Spec)](#section-4--sub-account-architecture-engineering-spec)
- [Section 5 — Fulfillment Dashboard (Product Spec)](#section-5--fulfillment-dashboard-product-spec)
- [Section 6 — Agency SLA Spec](#section-6--agency-sla-spec)
- [Section 7 — Marketing Assets for Agencies](#section-7--marketing-assets-for-agencies)
- [Section 8 — Agency Revenue Share Program](#section-8--agency-revenue-share-program)

---

## Section 1 — Agency Sales Deck

**Format:** 15 slides, ~25 minutes including live demo. Deck lives in Pitch (master file: `agency-deck-master`), exported to PDF + Keynote + Google Slides. Sales reps run this; we also publish a self-serve recorded version at `gofunnelai.com/for-agencies/watch`.

**Deck-wide design rules:** dark navy background, one big number per slide, max 12 words of slide copy. Speaker notes do the heavy lifting. Slides 6 (demo) and 14 (certification) are the two emotional peaks — pacing should accelerate into 6 and slow into 15.

---

### Slide 1 — The opportunity: every local business needs lead gen; most agencies can't deliver
...
**Speaker notes**
Acknowledge their pain — every agency in the room has tried at least two of these. ClickFunnels works for the 1% of clients who'll do the work; for the other 99% it's shelfware. Manual agency builds have great margins on the build fee but terrible margins on retainers because you keep getting pulled into iteration. The in-house hire is the worst trap because it lets clients believe they don't need you. The unifying theme: a human is in the critical path of every funnel.

---

### Slide 3 — The new way: AI-generated funnels in 60 seconds per client
...
**Speaker notes**
Tease the demo coming on slide 6. The 60-second number is real and we'll prove it live. What gets generated: landing page, lead-magnet flow, email sequence (5-7 emails), SMS sequence, voice script, and ad creative variants. All seeded from the client's existing site, brand colors pulled automatically, copy tuned to the vertical KB pack. The agency owner's job changes from "build funnels" to "approve funnels and scale ads" — a much higher-leverage role.

---

### Slide 4 — What you get with the Agency tier

**On-slide content**
- Header: "Agency tier — $997/mo"
...
**Speaker notes**
Walk the bullets but linger on three: (1) the sub-account cap is soft — we lift it for anyone with a credible roster, just ask; (2) RevTry minutes are *pooled*, which is huge because most clients use 20-50 minutes/mo and a few use 500, so pooling lets you re-allocate without per-client overage panic; (3) snapshot library is the compounding asset — every winning funnel you build becomes a template you redeploy across your book. After 6 months an agency that has snapshot'd 15 verticals onboards new clients in under 30 minutes.
...
- Two-column P&L
  ...
  - COGS: $997/mo (your GoFunnelAI seat)
...
**Speaker notes**
This is the moment. Ask the room: what's the most painful vertical you have right now? They'll shout something — dental, HVAC, med-spa, real estate, whatever. Take it, plug in a real local business URL from that vertical (sales rep has a list of pre-warmed safe URLs to use — never use a competitor agency's client). Generate. Walk through what came out: landing page, copy, offer, brand color match, email 1, SMS 1, the voice agent's opening line. Don't skip the compliance pre-check — that's where TCPA-aware competitors lose to us. If anything looks off, that's fine — show the regenerate button. The demo should land at 90 seconds wall-clock, including narration. If it takes longer your network is the issue; fall back to the recorded version (always queued in browser tab 2).

---

### Slide 7 — White-label: your branding, your domain, your support tier

**On-slide content**
- Three before/after pairs:
  - Login screen: GoFunnelAI logo â†’ Your agency logo
  - Domain: `app.gofunnelai.com/wsp_abc` â†’ `app.acmemarketing.com`
  - Outbound email: `noreply@gofunnelai.com` â†’ `noreply@acmemarketing.com`
- Footer: "Your clients never see our brand. Your name, our engine."

**Speaker notes**
Explain what white-label actually means here: clients log in at your domain, see your logo on every screen, receive every transactional email from your sending domain (we set up DKIM/DMARC for you), and — critically — when they need support, they email *you*, not us. You have a private agency-tier Slack with our team for escalations, but to your clients we're invisible. This is non-negotiable for agencies who've been burned by "white-label" that leaks our brand in five places. We hold ourselves to the standard: zero leakage of the word "GoFunnelAI" on a client-facing surface unless the agency opts in.

---

### Slide 8 — The 30 industries supported on Day 1
...
### Slide 9 — RevTry voice agent: how it changes lead-to-close conversion

**On-slide content**
- Big stat: "Inbound leads called within 60 seconds convert at 8x the rate of leads called after 5 minutes." — Source: Lead Response Management Study (Oldroyd et al.)
...
**Speaker notes**
The 8x stat is the most powerful number in this deck for sophisticated agency owners. Most of their clients aren't calling leads back within 60 seconds — they're calling within 4 hours, if at all. RevTry's job is to be the speed-to-lead layer the client always wished they had a receptionist for. The voice agent qualifies, books, and warm-transfers when appropriate. Module 6 of the certification teaches script customization. Mention: we're not selling "AI receptionist" — we're selling "the first 60 seconds after a lead converts." That framing matters.

---

### Slide 10 — Compliance moat: HIPAA, TCPA, FTC — built in
...
**Speaker notes**
Agencies undervalue compliance until they get sued or their client gets sued. We've seen $500k TCPA settlements wipe out small agencies. We do the unsexy work: every SMS template has been reviewed against TCPA, every healthcare funnel has PHI handling baked in, our trust & safety queue (see Doc 07b) reviews edge cases. Mention the Publish Acknowledgment & Indemnification doc (05e) — by signing it, both sides know exactly who owns what risk, and that clarity is a sales asset for agencies pitching enterprise local businesses.

---

### Slide 11 — GoFunnelAI Awards + Community

**On-slide content**
- Visual: trophy + Slack/Discord logos
- Bullets:
  - GoFunnelAI Awards: quarterly recognition for top-converting funnels by vertical
...
**Speaker notes**
This is the retention slide. Local-business owners — your clients — are starved for recognition. The GoFunnelAI Awards is a free quarterly program where we feature winning funnels, and the *agency that built them* is credited prominently. Agencies report that submitting clients to Awards is one of the highest-leverage QBR moments because it lets the client tell their spouse "I won an award" and reframes the agency relationship from cost to status. The community Slack is also where you'll meet your future referral partners — see Section 8 on the revenue share program.

---

### Slide 12 — The fulfillment dashboard
...
**Deliverables**
- Populated brand profile in the sub-account (visible to agency and — if shared — to the client).
...
### Step 3 — Funnel generation + approval

**Timeline:** Day 3-7. One 60-minute live session + up to 3 iteration rounds.

**Agency tasks**
- Host a screen-share where the funnel is generated *live in front of the client*. This is the wow moment — never skip the live generation. Agencies who pre-generate and present a finished funnel get 30% lower client engagement scores in our data.
...
### Step 4 — Launch package

**Timeline:** Day 7-10.

**Agency tasks**
- Walk the client through connecting their ad accounts (Meta Business Manager admin invite, Google Ads MCC link).
- Configure the custom domain — agency typically chooses `[client-name].agency-domain.com` or, for premium clients, `go.[client-domain].com` with CNAME setup.
...
**Timeline:** Recurring — weekly + monthly + quarterly cadence.
...
- **Quarterly:** Strategic review. Re-pricing conversation if client's lead volume has materially changed. Submit the client to GoFunnelAI Awards if they had a winning quarter. Talk renewal.
...
## Section 3 — Certification Course: "GoFunnelAI for Agencies"
...
**On pass:**
- GoFunnelAI Certified Agency badge (SVG + 3 PNG sizes) for use on the agency's website
- Listing in the public Partner Directory at `gofunnelai.com/partners` with vertical specialization, geography, agency bio, and a direct CTA-to-book button
...
### Module 1 — The agency growth playbook (intro by founder)

**Duration:** 4 minutes.

**Script outline**
Cold open: founder addresses the agency owner directly. "If you're watching this, you already run an agency. You don't need a sales pitch — you need a playbook that lets you serve 3x the clients with the same team. That's what this course is."

Three points:
1. **The shape of an agency that wins with GoFunnelAI:** specialized, productized, retention-focused. Not "we do everything for everyone."
2. **The shape of an agency that loses with GoFunnelAI:** generalist, custom-everything, hourly-billing. The platform won't save a service business addicted to scope creep.
...
### Module 2 — Platform tour: sub-accounts, white-label, snapshot library
...
### Module 3 — The 30 industries deep-dive (which to specialize in for highest LTV)
...
- **Regulatory complexity** (low/med/high — affects fulfillment cost)

Highest-LTV verticals: med-spa (LTV $24k+, low churn), law-PI (LTV $30k+, very low churn but high regulatory), financial advisor (LTV $20k+, high regulatory). Highest-volume verticals: home services (LTV $8k, easy fulfillment, but more competitive). Easiest-to-start verticals for a new GoFunnelAI agency: dental, chiropractic, HVAC, salon — all have proven KB packs and forgiving CPL economics.
...
### Module 4 — How to package and price (3 service tiers with margin breakdowns)
...
### Module 5 — Client retention through GoFunnelAI Awards + Community
...
1. **GoFunnelAI Awards (quarterly):** submit winning client funnels for recognition. Award recipients get a website badge, a feature in our newsletter, and (if they consent) a case study on our site that credits the agency. Submitting a client is a free QBR moment that always lands well.
2. **Community:** invite high-value clients to the public GoFunnelAI community (separate from the agency Slack). This builds peer-network attachment that makes switching agencies painful.
...
### Module 6 — RevTry voice script customization
...
- When to warm-transfer vs. when to book vs. when to SMS-only — the decision tree.
...
### Module 7 — Compliance for agencies (your liability vs ours)
...
2. **Running healthcare funnels without the BAA.** If the vertical is HIPAA-relevant, request the BAA from your GoFunnelAI account manager before publish.
...
### Module 8 — Scaling past 50 clients (fulfillment ops + team structure)
...
- **1 Agency Owner** — sales, partnerships, strategic accounts.
- **1 Account Manager per ~25 clients** — weekly digests, monthly calls, QBRs. Hire profile: communicator, not a strategist.
- **1 Funnel Operator per ~50 clients** — runs the platform: brand intake, funnel generation, approvals, A/B test queue. Hire profile: operations-detail-oriented.
- **1 Ad Buyer per ~30 active-paid-ad clients** — Meta + Google management. Hire profile: trader mindset, dashboard-fluent.
- **Fractional compliance reviewer** — quarterly review of templates and disclaimer use; usually 4 hours/month.

Tooling beyond GoFunnelAI: a project management tool (we recommend Linear or ClickUp), a billing system that handles passthrough or absorbed billing (Stripe Connect works well), a contract tool (Docusign or PandaDoc), and a Slack or Discord workspace.

When you cross 100 clients you should be selling the agency, hiring an agency director, or starting a vertical-specialty spin-off. Reach out to your partnerships lead — we know operators in your stage.
...
6. Under TCPA, when must SMS quiet hours be enforced? (Multi-select: morning before 8am, evening after 9pm, weekends, holidays, recipient's local time). **Correct: morning before 8am, evening after 9pm — by recipient's local time.**
...
9. The GoFunnelAI Publish Acknowledgment (Doc 05e) governs which of: (a) Agency liability (b) Client business claims (c) Platform compliance posture (d) All of the above. **Correct: d.**
...
13. Snapshot brand-substitution does NOT auto-substitute which of: (a) Brand colors (b) Logo (c) Client testimonials (d) Phone number. **Correct: c — testimonials must be re-supplied per client.**
14. A2P 10DLC registration typically takes: (a) Same day (b) 2-7 days (c) 30 days (d) Doesn't apply to agencies. **Correct: b.**
15. The GoFunnelAI Awards cadence is: (a) Monthly (b) Quarterly (c) Annual (d) Continuous. **Correct: b.**
...
## Section 4 — Sub-Account Architecture (Engineering Spec)
...
AgencyAccount (parent)
  ...
  â””â”€ … up to 100 by default (soft cap)
```
...
- DNS: agency points a CNAME from their chosen domain (e.g., `clients.acmemarketing.com`) to `agencies.gofunnelai.com`. Our edge layer maps the incoming Host header to a `whitelabel_configs` row and serves the appropriate brand assets.
...
- App UI: a `theme` middleware resolves to the agency theme at request time when `request.host` matches a verified white-label domain. Falls back to GoFunnelAI brand otherwise.
...
| 3 | `subaccount_archived` | `agency-svc` | `agency_id`, `workspace_id`, `actor_user_id`, `reason` | — | Lifecycle | 7y | P1 |
| 4 | `whitelabel_domain_verified` | `agency-svc` | `agency_id`, `domain` | — | Onboarding, support | 7y | P1 |
...
| 8 | `pool_threshold_reached` | `agency-svc` | `agency_id`, `resource`, `threshold_pct` | — | Notifications | 7y | P1 |
| 9 | `agency_certified` | `partners-svc` | `agency_id`, `user_id`, `score`, `attempts` | — | Growth | 7y | P1 |
...
| 12 | `affiliate_payout_initiated` | `affiliate-svc` | `agency_id`, `period_start`, `period_end`, `amount_micros`, `currency` | — | Finance, audit | 7y | P1 |
| 13 | `affiliate_payout_paid` | `affiliate-svc` | `agency_id`, `payout_id`, `payout_reference` | — | Finance | 7y | P1 |
...
## Section 5 — Fulfillment Dashboard (Product Spec)
...
|  • Acme Dental — variant B awaiting approval (2d open)              [Open]     |
|  • Bob's HVAC — Meta ad rejected: disclaimer missing                [Open]     |
|  • Diamond Spa — RevTry script change requested by client            [Open]    |
+--------------------------------------------------------------------------------+
```

### 5.2 Client list — columns
...
Health is descriptive, not prescriptive — never auto-pause based on health alone. The dashboard always suggests an action ("Schedule check-in" / "Approve variant" / "Review compliance flag").
...
- Slack is the **support escalation channel**, not the support intake channel — formal tickets still flow through the in-app help center for tracking. Slack is for "hey we have a thing" warm escalation.
...
## Section 7 — Marketing Assets for Agencies
...
**Variant A — "The Lead-Gen Promise"** (best for cold traffic from paid social)
- Hero: "Get [N] qualified [vertical] leads in the next 30 days — or we work for free."
- Three trust badges: "Meta Business Partner • Google Premier • GoFunnelAI Certified."
...
**Variant B — "The Authority Build"** (best for warm referrals and content)
...
**Variant C — "The Speed Pitch"** (best for retargeting and email)
...
1. **"Quick question about [client]'s marketing"** — cold introduction, references something specific about the prospect's business.
2. **"I built a sample funnel for [client] — want to see it?"** — value-first, attaches a 30-second video walkthrough of a funnel auto-generated for the prospect's URL.
3. **"Re: our chat — sending the proposal"** — post-discovery follow-up with proposal link and a clear next step.
4. **"3 things [vertical] businesses are getting wrong in 2026"** — nurture email pointing to a relevant case study or playbook.
5. **"Last check-in — should I close out the file?"** — break-up email, surprisingly high open and reply rates.
...
1. "Here's what a [vertical] funnel looks like in 2026" — annotated screenshot.
2. "We just delivered [client] their 100th lead in 30 days" — single big number.
3. "The 60-second test" — short video clip of a funnel being generated.
4. "Three things I'd never put in a [vertical] ad" — carousel.
5. "Behind the scenes — how we run 30 clients with 3 people" — team photo + workflow.
6. "[Client] won a GoFunnelAI Award this quarter" — agency credit, builds social proof.
7. "Compliance fundamentals every [vertical] should know" — educational.
8. "Hot take — most [vertical] marketing in 2026 is broken because…" — opinion.
9. "Our biggest mistake last quarter and what we learned" — vulnerability + lesson.
10. "DM us a URL and we'll build you a funnel — free" — value-bait, drives conversations.
...
- Result: KPIs (leads, conversion, ROI) — with timeframe.
- Quote: 1-2 sentence client testimonial.
- Visuals: a screenshot of the funnel + a chart.
- CTA: "Want results like this? Book a call."

Template renders as both a one-page PDF (agency print/email) and a web page on the agency's site (provided as a snippet they can embed). Ships with a fill-in workflow in the dashboard — the agency picks a client, the system pre-fills KPIs from actuals, the agency writes the narrative and exports.

### 7.6 Cold outreach email templates (5)

Sender: agency. Use case: outbound prospecting to local businesses in a chosen vertical and geography. Each template includes subject + body + 2 follow-up emails (so really 15 emails total). Same compliance posture as Section 7.2 — CAN-SPAM compliant, includes physical address + unsubscribe.

Topics:
1. **Generic value-first** — "I noticed [specific thing] about [business]. Quick idea."
2. **Competitive intel** — "Your competitor [X] is running these ads. Here's how I'd respond."
3. **Local landmark / news** — references a specific local event/news item for warmth.
4. **Loom video** — 90-second personal video, embedded thumbnail in email.
5. **Direct offer** — "Free funnel audit, 30 mins, no pitch."

Best opener-to-meeting rate in our agency cohort data: #4 (Loom video), at ~3.2% reply-to-meeting conversion.

---

## Section 8 — Agency Revenue Share Program

The viral kicker. Designed to make GoFunnelAI the obvious referral for every agency-shaped network — masterminds, conferences, Slack communities, podcasts.

### 8.1 The two earnings paths

**Path 1 — Agency-to-agency referral**
- An agency on GoFunnelAI (the referrer) refers another agency to the platform.
...
**Path 2 — Client-to-direct-customer conversion**
- An agency's client (a local business) decides they want to manage GoFunnelAI directly rather than through the agency. We accommodate this — they convert from a sub-account into a standalone Workspace, with their data intact.
...
- The agency's affiliate link is `gofunnelai.com/r/<affiliate_code>` and a deep-link UTM variant for tracking provenance.
- Attribution window for path 1 (agency-to-agency): 60 days from first click. Last-click attribution.
- Attribution window for path 2 (client-to-direct): unlimited — if the client's standalone workspace was ever a sub-account under the agency, the agency is permanently credited.
...
- Suspected fraudulent attribution (fake signups, paid-for click farms, brand-name SEO squatting on "GoFunnelAI" in violation of our marks policy) results in immediate forfeit of pending and future earnings, plus possible account suspension.
...
- Joint webinars to the GoFunnelAI customer base.
- "GoFunnelAI Featured Partner" badge in the directory with priority placement.
...
| **White-label** | The full visual + sender + support replacement of GoFunnelAI branding with the agency's branding across all client-facing surfaces. |
...
| **KB pack** | A vertical-specific knowledge base shipped with GoFunnelAI, containing offers, scripts, compliance rules, and CPL benchmarks. |
...
| **GoFunnelAI Awards** | Quarterly recognition program for top-performing client funnels; submitted by agencies. |
| **Affiliate code** | Unique short string per agency used to attribute referral revenue. |
| **Passthrough billing** | Billing mode where GoFunnelAI bills the client directly on the agency's behalf via Stripe Connect. |
| **Absorbed billing** | Billing mode where the agency bills the client and GoFunnelAI bills only the agency. |
| **Client-view role** | A workspace role giving a client login access to only their own workspace, branded by the agency. |
| **Partner Directory** | Our public-facing list of certified agencies at `gofunnelai.com/partners`, with vertical and geographic filters. |

...
import { isValidShareCode } from "@/lib/grader/share-code";
import { shareMetadata } from "@/lib/grader/seo";
import { displayUrl } from "@/lib/grader/utils";
...
export default async function SharePage({ params }: SharePageProps) {
  ...
  const score: FinalScore = {
    ...
    subscores: (audit.subscores as unknown as FinalScore["subscores"]) ?? {
      hook: 0,
      form: 0,
      trust: 0,
      speed: 0,
